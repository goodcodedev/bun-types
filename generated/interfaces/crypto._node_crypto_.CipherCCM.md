...
[crypto](../modules/crypto.md).["node:crypto"](../modules/crypto._node_crypto_.md).CipherCCM
...
- [allowHalfOpen](crypto._node_crypto_.CipherCCM.md#allowhalfopen)
- [destroyed](crypto._node_crypto_.CipherCCM.md#destroyed)
- [locked](crypto._node_crypto_.CipherCCM.md#locked)
- [readable](crypto._node_crypto_.CipherCCM.md#readable)
- [readableAborted](crypto._node_crypto_.CipherCCM.md#readableaborted)
- [readableEncoding](crypto._node_crypto_.CipherCCM.md#readableencoding)
- [readableEnded](crypto._node_crypto_.CipherCCM.md#readableended)
- [readableFlowing](crypto._node_crypto_.CipherCCM.md#readableflowing)
- [readableHighWaterMark](crypto._node_crypto_.CipherCCM.md#readablehighwatermark)
- [readableLength](crypto._node_crypto_.CipherCCM.md#readablelength)
- [readableObjectMode](crypto._node_crypto_.CipherCCM.md#readableobjectmode)
- [writable](crypto._node_crypto_.CipherCCM.md#writable)
- [writableCorked](crypto._node_crypto_.CipherCCM.md#writablecorked)
- [writableEnded](crypto._node_crypto_.CipherCCM.md#writableended)
- [writableFinished](crypto._node_crypto_.CipherCCM.md#writablefinished)
- [writableHighWaterMark](crypto._node_crypto_.CipherCCM.md#writablehighwatermark)
- [writableLength](crypto._node_crypto_.CipherCCM.md#writablelength)
- [writableObjectMode](crypto._node_crypto_.CipherCCM.md#writableobjectmode)

### Methods

- [[asyncIterator]](crypto._node_crypto_.CipherCCM.md#[asynciterator])
- [\_construct](crypto._node_crypto_.CipherCCM.md#_construct)
- [\_destroy](crypto._node_crypto_.CipherCCM.md#_destroy)
- [\_final](crypto._node_crypto_.CipherCCM.md#_final)
- [\_flush](crypto._node_crypto_.CipherCCM.md#_flush)
- [\_read](crypto._node_crypto_.CipherCCM.md#_read)
- [\_transform](crypto._node_crypto_.CipherCCM.md#_transform)
- [\_write](crypto._node_crypto_.CipherCCM.md#_write)
- [\_writev](crypto._node_crypto_.CipherCCM.md#_writev)
- [abort](crypto._node_crypto_.CipherCCM.md#abort)
- [addListener](crypto._node_crypto_.CipherCCM.md#addlistener)
- [cancel](crypto._node_crypto_.CipherCCM.md#cancel)
- [close](crypto._node_crypto_.CipherCCM.md#close)
- [cork](crypto._node_crypto_.CipherCCM.md#cork)
- [destroy](crypto._node_crypto_.CipherCCM.md#destroy)
- [emit](crypto._node_crypto_.CipherCCM.md#emit)
- [end](crypto._node_crypto_.CipherCCM.md#end)
- [eventNames](crypto._node_crypto_.CipherCCM.md#eventnames)
- [final](crypto._node_crypto_.CipherCCM.md#final)
- [forEach](crypto._node_crypto_.CipherCCM.md#foreach)
- [getAuthTag](crypto._node_crypto_.CipherCCM.md#getauthtag)
- [getMaxListeners](crypto._node_crypto_.CipherCCM.md#getmaxlisteners)
- [getReader](crypto._node_crypto_.CipherCCM.md#getreader)
- [getWriter](crypto._node_crypto_.CipherCCM.md#getwriter)
- [isPaused](crypto._node_crypto_.CipherCCM.md#ispaused)
- [listenerCount](crypto._node_crypto_.CipherCCM.md#listenercount)
- [listeners](crypto._node_crypto_.CipherCCM.md#listeners)
- [off](crypto._node_crypto_.CipherCCM.md#off)
- [on](crypto._node_crypto_.CipherCCM.md#on)
- [once](crypto._node_crypto_.CipherCCM.md#once)
- [pause](crypto._node_crypto_.CipherCCM.md#pause)
- [pipe](crypto._node_crypto_.CipherCCM.md#pipe)
- [pipeThrough](crypto._node_crypto_.CipherCCM.md#pipethrough)
- [pipeTo](crypto._node_crypto_.CipherCCM.md#pipeto)
- [prependListener](crypto._node_crypto_.CipherCCM.md#prependlistener)
- [prependOnceListener](crypto._node_crypto_.CipherCCM.md#prependoncelistener)
- [push](crypto._node_crypto_.CipherCCM.md#push)
- [rawListeners](crypto._node_crypto_.CipherCCM.md#rawlisteners)
- [read](crypto._node_crypto_.CipherCCM.md#read)
- [removeAllListeners](crypto._node_crypto_.CipherCCM.md#removealllisteners)
- [removeListener](crypto._node_crypto_.CipherCCM.md#removelistener)
- [resume](crypto._node_crypto_.CipherCCM.md#resume)
- [setAAD](crypto._node_crypto_.CipherCCM.md#setaad)
- [setAutoPadding](crypto._node_crypto_.CipherCCM.md#setautopadding)
- [setDefaultEncoding](crypto._node_crypto_.CipherCCM.md#setdefaultencoding)
- [setEncoding](crypto._node_crypto_.CipherCCM.md#setencoding)
- [setMaxListeners](crypto._node_crypto_.CipherCCM.md#setmaxlisteners)
- [tee](crypto._node_crypto_.CipherCCM.md#tee)
- [uncork](crypto._node_crypto_.CipherCCM.md#uncork)
- [unpipe](crypto._node_crypto_.CipherCCM.md#unpipe)
- [unshift](crypto._node_crypto_.CipherCCM.md#unshift)
- [update](crypto._node_crypto_.CipherCCM.md#update)
- [wrap](crypto._node_crypto_.CipherCCM.md#wrap)
- [write](crypto._node_crypto_.CipherCCM.md#write)
...
▸ **addListener**(`event`, `listener`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
[`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
The buffered data will be flushed when either the [uncork](crypto._node_crypto_.CipherCCM.md#uncork) or [end](crypto._node_crypto_.CipherCCM.md#end) methods are called.
...
▸ **destroy**(`error?`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
▸ **end**(`cb?`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
Calling the [write](crypto._node_crypto_.CipherCCM.md#write) method after calling [end](crypto._node_crypto_.CipherCCM.md#end) will raise an error.
...
▸ **end**(`chunk`, `cb?`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
▸ **end**(`chunk`, `encoding?`, `cb?`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
[crypto.d.ts:957](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/crypto.d.ts#L957)
...
▸ **off**(`eventName`, `listener`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
▸ **on**(`event`, `listener`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
▸ **once**(`event`, `listener`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
▸ **pause**(): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
▸ **prependListener**(`event`, `listener`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
▸ **prependOnceListener**(`event`, `listener`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
Calling [read](crypto._node_crypto_.CipherCCM.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
▸ **removeListener**(`event`, `listener`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
▸ **resume**(): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
▸ **setAAD**(`buffer`, `options`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
[crypto.d.ts:951](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/crypto.d.ts#L951)

___

### setAutoPadding

▸ **setAutoPadding**(`autoPadding?`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
▸ **setDefaultEncoding**(`encoding`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
▸ **setEncoding**(`encoding`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
▸ **setMaxListeners**(`n`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._node_crypto_.CipherCCM.md#cork) was called.
...
▸ **unpipe**(`destination?`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](crypto._node_crypto_.CipherCCM.md#pipe) method.
...
Unlike [push](crypto._node_crypto_.CipherCCM.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto._node_crypto_.CipherCCM.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto._node_crypto_.CipherCCM.md#push) will reset the reading state appropriately,
...
▸ **wrap**(`stream`): [`CipherCCM`](crypto._crypto_.CipherCCM.md)

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](crypto._node_crypto_.CipherCCM.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._node_crypto_.CipherCCM.md#pipe). However, if calling `write()` is preferred, it is
