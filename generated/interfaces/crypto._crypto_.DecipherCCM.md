...
[crypto](../modules/crypto.md).["crypto"](../modules/crypto._crypto_.md).DecipherCCM
...
- [allowHalfOpen](crypto._crypto_.DecipherCCM.md#allowhalfopen)
- [destroyed](crypto._crypto_.DecipherCCM.md#destroyed)
- [locked](crypto._crypto_.DecipherCCM.md#locked)
- [readable](crypto._crypto_.DecipherCCM.md#readable)
- [readableAborted](crypto._crypto_.DecipherCCM.md#readableaborted)
- [readableEncoding](crypto._crypto_.DecipherCCM.md#readableencoding)
- [readableEnded](crypto._crypto_.DecipherCCM.md#readableended)
- [readableFlowing](crypto._crypto_.DecipherCCM.md#readableflowing)
- [readableHighWaterMark](crypto._crypto_.DecipherCCM.md#readablehighwatermark)
- [readableLength](crypto._crypto_.DecipherCCM.md#readablelength)
- [readableObjectMode](crypto._crypto_.DecipherCCM.md#readableobjectmode)
- [writable](crypto._crypto_.DecipherCCM.md#writable)
- [writableCorked](crypto._crypto_.DecipherCCM.md#writablecorked)
- [writableEnded](crypto._crypto_.DecipherCCM.md#writableended)
- [writableFinished](crypto._crypto_.DecipherCCM.md#writablefinished)
- [writableHighWaterMark](crypto._crypto_.DecipherCCM.md#writablehighwatermark)
- [writableLength](crypto._crypto_.DecipherCCM.md#writablelength)
- [writableObjectMode](crypto._crypto_.DecipherCCM.md#writableobjectmode)

### Methods

- [[asyncIterator]](crypto._crypto_.DecipherCCM.md#[asynciterator])
- [\_construct](crypto._crypto_.DecipherCCM.md#_construct)
- [\_destroy](crypto._crypto_.DecipherCCM.md#_destroy)
- [\_final](crypto._crypto_.DecipherCCM.md#_final)
- [\_flush](crypto._crypto_.DecipherCCM.md#_flush)
- [\_read](crypto._crypto_.DecipherCCM.md#_read)
- [\_transform](crypto._crypto_.DecipherCCM.md#_transform)
- [\_write](crypto._crypto_.DecipherCCM.md#_write)
- [\_writev](crypto._crypto_.DecipherCCM.md#_writev)
- [abort](crypto._crypto_.DecipherCCM.md#abort)
- [addListener](crypto._crypto_.DecipherCCM.md#addlistener)
- [cancel](crypto._crypto_.DecipherCCM.md#cancel)
- [close](crypto._crypto_.DecipherCCM.md#close)
- [cork](crypto._crypto_.DecipherCCM.md#cork)
- [destroy](crypto._crypto_.DecipherCCM.md#destroy)
- [emit](crypto._crypto_.DecipherCCM.md#emit)
- [end](crypto._crypto_.DecipherCCM.md#end)
- [eventNames](crypto._crypto_.DecipherCCM.md#eventnames)
- [final](crypto._crypto_.DecipherCCM.md#final)
- [forEach](crypto._crypto_.DecipherCCM.md#foreach)
- [getMaxListeners](crypto._crypto_.DecipherCCM.md#getmaxlisteners)
- [getReader](crypto._crypto_.DecipherCCM.md#getreader)
- [getWriter](crypto._crypto_.DecipherCCM.md#getwriter)
- [isPaused](crypto._crypto_.DecipherCCM.md#ispaused)
- [listenerCount](crypto._crypto_.DecipherCCM.md#listenercount)
- [listeners](crypto._crypto_.DecipherCCM.md#listeners)
- [off](crypto._crypto_.DecipherCCM.md#off)
- [on](crypto._crypto_.DecipherCCM.md#on)
- [once](crypto._crypto_.DecipherCCM.md#once)
- [pause](crypto._crypto_.DecipherCCM.md#pause)
- [pipe](crypto._crypto_.DecipherCCM.md#pipe)
- [pipeThrough](crypto._crypto_.DecipherCCM.md#pipethrough)
- [pipeTo](crypto._crypto_.DecipherCCM.md#pipeto)
- [prependListener](crypto._crypto_.DecipherCCM.md#prependlistener)
- [prependOnceListener](crypto._crypto_.DecipherCCM.md#prependoncelistener)
- [push](crypto._crypto_.DecipherCCM.md#push)
- [rawListeners](crypto._crypto_.DecipherCCM.md#rawlisteners)
- [read](crypto._crypto_.DecipherCCM.md#read)
- [removeAllListeners](crypto._crypto_.DecipherCCM.md#removealllisteners)
- [removeListener](crypto._crypto_.DecipherCCM.md#removelistener)
- [resume](crypto._crypto_.DecipherCCM.md#resume)
- [setAAD](crypto._crypto_.DecipherCCM.md#setaad)
- [setAuthTag](crypto._crypto_.DecipherCCM.md#setauthtag)
- [setAutoPadding](crypto._crypto_.DecipherCCM.md#setautopadding)
- [setDefaultEncoding](crypto._crypto_.DecipherCCM.md#setdefaultencoding)
- [setEncoding](crypto._crypto_.DecipherCCM.md#setencoding)
- [setMaxListeners](crypto._crypto_.DecipherCCM.md#setmaxlisteners)
- [tee](crypto._crypto_.DecipherCCM.md#tee)
- [uncork](crypto._crypto_.DecipherCCM.md#uncork)
- [unpipe](crypto._crypto_.DecipherCCM.md#unpipe)
- [unshift](crypto._crypto_.DecipherCCM.md#unshift)
- [update](crypto._crypto_.DecipherCCM.md#update)
- [wrap](crypto._crypto_.DecipherCCM.md#wrap)
- [write](crypto._crypto_.DecipherCCM.md#write)
...
The buffered data will be flushed when either the [uncork](crypto._crypto_.DecipherCCM.md#uncork) or [end](crypto._crypto_.DecipherCCM.md#end) methods are called.
...
Calling the [write](crypto._crypto_.DecipherCCM.md#write) method after calling [end](crypto._crypto_.DecipherCCM.md#end) will raise an error.
...
Calling [read](crypto._crypto_.DecipherCCM.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._crypto_.DecipherCCM.md#cork) was called.
...
using the [pipe](crypto._crypto_.DecipherCCM.md#pipe) method.
...
Unlike [push](crypto._crypto_.DecipherCCM.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto._crypto_.DecipherCCM.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto._crypto_.DecipherCCM.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto._crypto_.DecipherCCM.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._crypto_.DecipherCCM.md#pipe). However, if calling `write()` is preferred, it is
