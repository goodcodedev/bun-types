...
[crypto](../modules/crypto.md).["crypto"](../modules/crypto._crypto_.md).CipherOCB
...
- [allowHalfOpen](crypto._crypto_.CipherOCB.md#allowhalfopen)
- [destroyed](crypto._crypto_.CipherOCB.md#destroyed)
- [locked](crypto._crypto_.CipherOCB.md#locked)
- [readable](crypto._crypto_.CipherOCB.md#readable)
- [readableAborted](crypto._crypto_.CipherOCB.md#readableaborted)
- [readableEncoding](crypto._crypto_.CipherOCB.md#readableencoding)
- [readableEnded](crypto._crypto_.CipherOCB.md#readableended)
- [readableFlowing](crypto._crypto_.CipherOCB.md#readableflowing)
- [readableHighWaterMark](crypto._crypto_.CipherOCB.md#readablehighwatermark)
- [readableLength](crypto._crypto_.CipherOCB.md#readablelength)
- [readableObjectMode](crypto._crypto_.CipherOCB.md#readableobjectmode)
- [writable](crypto._crypto_.CipherOCB.md#writable)
- [writableCorked](crypto._crypto_.CipherOCB.md#writablecorked)
- [writableEnded](crypto._crypto_.CipherOCB.md#writableended)
- [writableFinished](crypto._crypto_.CipherOCB.md#writablefinished)
- [writableHighWaterMark](crypto._crypto_.CipherOCB.md#writablehighwatermark)
- [writableLength](crypto._crypto_.CipherOCB.md#writablelength)
- [writableObjectMode](crypto._crypto_.CipherOCB.md#writableobjectmode)

### Methods

- [[asyncIterator]](crypto._crypto_.CipherOCB.md#[asynciterator])
- [\_construct](crypto._crypto_.CipherOCB.md#_construct)
- [\_destroy](crypto._crypto_.CipherOCB.md#_destroy)
- [\_final](crypto._crypto_.CipherOCB.md#_final)
- [\_flush](crypto._crypto_.CipherOCB.md#_flush)
- [\_read](crypto._crypto_.CipherOCB.md#_read)
- [\_transform](crypto._crypto_.CipherOCB.md#_transform)
- [\_write](crypto._crypto_.CipherOCB.md#_write)
- [\_writev](crypto._crypto_.CipherOCB.md#_writev)
- [abort](crypto._crypto_.CipherOCB.md#abort)
- [addListener](crypto._crypto_.CipherOCB.md#addlistener)
- [cancel](crypto._crypto_.CipherOCB.md#cancel)
- [close](crypto._crypto_.CipherOCB.md#close)
- [cork](crypto._crypto_.CipherOCB.md#cork)
- [destroy](crypto._crypto_.CipherOCB.md#destroy)
- [emit](crypto._crypto_.CipherOCB.md#emit)
- [end](crypto._crypto_.CipherOCB.md#end)
- [eventNames](crypto._crypto_.CipherOCB.md#eventnames)
- [final](crypto._crypto_.CipherOCB.md#final)
- [forEach](crypto._crypto_.CipherOCB.md#foreach)
- [getAuthTag](crypto._crypto_.CipherOCB.md#getauthtag)
- [getMaxListeners](crypto._crypto_.CipherOCB.md#getmaxlisteners)
- [getReader](crypto._crypto_.CipherOCB.md#getreader)
- [getWriter](crypto._crypto_.CipherOCB.md#getwriter)
- [isPaused](crypto._crypto_.CipherOCB.md#ispaused)
- [listenerCount](crypto._crypto_.CipherOCB.md#listenercount)
- [listeners](crypto._crypto_.CipherOCB.md#listeners)
- [off](crypto._crypto_.CipherOCB.md#off)
- [on](crypto._crypto_.CipherOCB.md#on)
- [once](crypto._crypto_.CipherOCB.md#once)
- [pause](crypto._crypto_.CipherOCB.md#pause)
- [pipe](crypto._crypto_.CipherOCB.md#pipe)
- [pipeThrough](crypto._crypto_.CipherOCB.md#pipethrough)
- [pipeTo](crypto._crypto_.CipherOCB.md#pipeto)
- [prependListener](crypto._crypto_.CipherOCB.md#prependlistener)
- [prependOnceListener](crypto._crypto_.CipherOCB.md#prependoncelistener)
- [push](crypto._crypto_.CipherOCB.md#push)
- [rawListeners](crypto._crypto_.CipherOCB.md#rawlisteners)
- [read](crypto._crypto_.CipherOCB.md#read)
- [removeAllListeners](crypto._crypto_.CipherOCB.md#removealllisteners)
- [removeListener](crypto._crypto_.CipherOCB.md#removelistener)
- [resume](crypto._crypto_.CipherOCB.md#resume)
- [setAAD](crypto._crypto_.CipherOCB.md#setaad)
- [setAutoPadding](crypto._crypto_.CipherOCB.md#setautopadding)
- [setDefaultEncoding](crypto._crypto_.CipherOCB.md#setdefaultencoding)
- [setEncoding](crypto._crypto_.CipherOCB.md#setencoding)
- [setMaxListeners](crypto._crypto_.CipherOCB.md#setmaxlisteners)
- [tee](crypto._crypto_.CipherOCB.md#tee)
- [uncork](crypto._crypto_.CipherOCB.md#uncork)
- [unpipe](crypto._crypto_.CipherOCB.md#unpipe)
- [unshift](crypto._crypto_.CipherOCB.md#unshift)
- [update](crypto._crypto_.CipherOCB.md#update)
- [wrap](crypto._crypto_.CipherOCB.md#wrap)
- [write](crypto._crypto_.CipherOCB.md#write)
...
The buffered data will be flushed when either the [uncork](crypto._crypto_.CipherOCB.md#uncork) or [end](crypto._crypto_.CipherOCB.md#end) methods are called.
...
Calling the [write](crypto._crypto_.CipherOCB.md#write) method after calling [end](crypto._crypto_.CipherOCB.md#end) will raise an error.
...
Calling [read](crypto._crypto_.CipherOCB.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._crypto_.CipherOCB.md#cork) was called.
...
using the [pipe](crypto._crypto_.CipherOCB.md#pipe) method.
...
Unlike [push](crypto._crypto_.CipherOCB.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto._crypto_.CipherOCB.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto._crypto_.CipherOCB.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto._crypto_.CipherOCB.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._crypto_.CipherOCB.md#pipe). However, if calling `write()` is preferred, it is
