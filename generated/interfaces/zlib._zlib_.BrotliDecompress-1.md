...
[zlib](../modules/zlib.md).["zlib"](../modules/zlib._zlib_.md).BrotliDecompress
...
- [allowHalfOpen](zlib._zlib_.BrotliDecompress-1.md#allowhalfopen)
- [bytesRead](zlib._zlib_.BrotliDecompress-1.md#bytesread)
- [bytesWritten](zlib._zlib_.BrotliDecompress-1.md#byteswritten)
- [destroyed](zlib._zlib_.BrotliDecompress-1.md#destroyed)
- [locked](zlib._zlib_.BrotliDecompress-1.md#locked)
- [readable](zlib._zlib_.BrotliDecompress-1.md#readable)
- [readableAborted](zlib._zlib_.BrotliDecompress-1.md#readableaborted)
- [readableEncoding](zlib._zlib_.BrotliDecompress-1.md#readableencoding)
- [readableEnded](zlib._zlib_.BrotliDecompress-1.md#readableended)
- [readableFlowing](zlib._zlib_.BrotliDecompress-1.md#readableflowing)
- [readableHighWaterMark](zlib._zlib_.BrotliDecompress-1.md#readablehighwatermark)
- [readableLength](zlib._zlib_.BrotliDecompress-1.md#readablelength)
- [readableObjectMode](zlib._zlib_.BrotliDecompress-1.md#readableobjectmode)
- [shell](zlib._zlib_.BrotliDecompress-1.md#shell)
- [writable](zlib._zlib_.BrotliDecompress-1.md#writable)
- [writableCorked](zlib._zlib_.BrotliDecompress-1.md#writablecorked)
- [writableEnded](zlib._zlib_.BrotliDecompress-1.md#writableended)
- [writableFinished](zlib._zlib_.BrotliDecompress-1.md#writablefinished)
- [writableHighWaterMark](zlib._zlib_.BrotliDecompress-1.md#writablehighwatermark)
- [writableLength](zlib._zlib_.BrotliDecompress-1.md#writablelength)
- [writableObjectMode](zlib._zlib_.BrotliDecompress-1.md#writableobjectmode)

### Methods

- [[asyncIterator]](zlib._zlib_.BrotliDecompress-1.md#[asynciterator])
- [\_construct](zlib._zlib_.BrotliDecompress-1.md#_construct)
- [\_destroy](zlib._zlib_.BrotliDecompress-1.md#_destroy)
- [\_final](zlib._zlib_.BrotliDecompress-1.md#_final)
- [\_flush](zlib._zlib_.BrotliDecompress-1.md#_flush)
- [\_read](zlib._zlib_.BrotliDecompress-1.md#_read)
- [\_transform](zlib._zlib_.BrotliDecompress-1.md#_transform)
- [\_write](zlib._zlib_.BrotliDecompress-1.md#_write)
- [\_writev](zlib._zlib_.BrotliDecompress-1.md#_writev)
- [abort](zlib._zlib_.BrotliDecompress-1.md#abort)
- [addListener](zlib._zlib_.BrotliDecompress-1.md#addlistener)
- [cancel](zlib._zlib_.BrotliDecompress-1.md#cancel)
- [close](zlib._zlib_.BrotliDecompress-1.md#close)
- [cork](zlib._zlib_.BrotliDecompress-1.md#cork)
- [destroy](zlib._zlib_.BrotliDecompress-1.md#destroy)
- [emit](zlib._zlib_.BrotliDecompress-1.md#emit)
- [end](zlib._zlib_.BrotliDecompress-1.md#end)
- [eventNames](zlib._zlib_.BrotliDecompress-1.md#eventnames)
- [flush](zlib._zlib_.BrotliDecompress-1.md#flush)
- [forEach](zlib._zlib_.BrotliDecompress-1.md#foreach)
- [getMaxListeners](zlib._zlib_.BrotliDecompress-1.md#getmaxlisteners)
- [getReader](zlib._zlib_.BrotliDecompress-1.md#getreader)
- [getWriter](zlib._zlib_.BrotliDecompress-1.md#getwriter)
- [isPaused](zlib._zlib_.BrotliDecompress-1.md#ispaused)
- [listenerCount](zlib._zlib_.BrotliDecompress-1.md#listenercount)
- [listeners](zlib._zlib_.BrotliDecompress-1.md#listeners)
- [off](zlib._zlib_.BrotliDecompress-1.md#off)
- [on](zlib._zlib_.BrotliDecompress-1.md#on)
- [once](zlib._zlib_.BrotliDecompress-1.md#once)
- [pause](zlib._zlib_.BrotliDecompress-1.md#pause)
- [pipe](zlib._zlib_.BrotliDecompress-1.md#pipe)
- [pipeThrough](zlib._zlib_.BrotliDecompress-1.md#pipethrough)
- [pipeTo](zlib._zlib_.BrotliDecompress-1.md#pipeto)
- [prependListener](zlib._zlib_.BrotliDecompress-1.md#prependlistener)
- [prependOnceListener](zlib._zlib_.BrotliDecompress-1.md#prependoncelistener)
- [push](zlib._zlib_.BrotliDecompress-1.md#push)
- [rawListeners](zlib._zlib_.BrotliDecompress-1.md#rawlisteners)
- [read](zlib._zlib_.BrotliDecompress-1.md#read)
- [removeAllListeners](zlib._zlib_.BrotliDecompress-1.md#removealllisteners)
- [removeListener](zlib._zlib_.BrotliDecompress-1.md#removelistener)
- [resume](zlib._zlib_.BrotliDecompress-1.md#resume)
- [setDefaultEncoding](zlib._zlib_.BrotliDecompress-1.md#setdefaultencoding)
- [setEncoding](zlib._zlib_.BrotliDecompress-1.md#setencoding)
- [setMaxListeners](zlib._zlib_.BrotliDecompress-1.md#setmaxlisteners)
- [tee](zlib._zlib_.BrotliDecompress-1.md#tee)
- [uncork](zlib._zlib_.BrotliDecompress-1.md#uncork)
- [unpipe](zlib._zlib_.BrotliDecompress-1.md#unpipe)
- [unshift](zlib._zlib_.BrotliDecompress-1.md#unshift)
- [wrap](zlib._zlib_.BrotliDecompress-1.md#wrap)
- [write](zlib._zlib_.BrotliDecompress-1.md#write)
...
The buffered data will be flushed when either the [uncork](zlib._zlib_.BrotliDecompress-1.md#uncork) or [end](zlib._zlib_.BrotliDecompress-1.md#end) methods are called.
...
Calling the [write](zlib._zlib_.BrotliDecompress-1.md#write) method after calling [end](zlib._zlib_.BrotliDecompress-1.md#end) will raise an error.
...
Calling [read](zlib._zlib_.BrotliDecompress-1.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](zlib._zlib_.BrotliDecompress-1.md#cork) was called.
...
using the [pipe](zlib._zlib_.BrotliDecompress-1.md#pipe) method.
...
Unlike [push](zlib._zlib_.BrotliDecompress-1.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](zlib._zlib_.BrotliDecompress-1.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](zlib._zlib_.BrotliDecompress-1.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](zlib._zlib_.BrotliDecompress-1.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](zlib._zlib_.BrotliDecompress-1.md#pipe). However, if calling `write()` is preferred, it is
