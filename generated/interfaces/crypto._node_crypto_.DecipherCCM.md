...
[crypto](../modules/crypto.md).["node:crypto"](../modules/crypto._node_crypto_.md).DecipherCCM
...
- [allowHalfOpen](crypto._node_crypto_.DecipherCCM.md#allowhalfopen)
- [destroyed](crypto._node_crypto_.DecipherCCM.md#destroyed)
- [locked](crypto._node_crypto_.DecipherCCM.md#locked)
- [readable](crypto._node_crypto_.DecipherCCM.md#readable)
- [readableAborted](crypto._node_crypto_.DecipherCCM.md#readableaborted)
- [readableEncoding](crypto._node_crypto_.DecipherCCM.md#readableencoding)
- [readableEnded](crypto._node_crypto_.DecipherCCM.md#readableended)
- [readableFlowing](crypto._node_crypto_.DecipherCCM.md#readableflowing)
- [readableHighWaterMark](crypto._node_crypto_.DecipherCCM.md#readablehighwatermark)
- [readableLength](crypto._node_crypto_.DecipherCCM.md#readablelength)
- [readableObjectMode](crypto._node_crypto_.DecipherCCM.md#readableobjectmode)
- [writable](crypto._node_crypto_.DecipherCCM.md#writable)
- [writableCorked](crypto._node_crypto_.DecipherCCM.md#writablecorked)
- [writableEnded](crypto._node_crypto_.DecipherCCM.md#writableended)
- [writableFinished](crypto._node_crypto_.DecipherCCM.md#writablefinished)
- [writableHighWaterMark](crypto._node_crypto_.DecipherCCM.md#writablehighwatermark)
- [writableLength](crypto._node_crypto_.DecipherCCM.md#writablelength)
- [writableObjectMode](crypto._node_crypto_.DecipherCCM.md#writableobjectmode)

### Methods

- [[asyncIterator]](crypto._node_crypto_.DecipherCCM.md#[asynciterator])
- [\_construct](crypto._node_crypto_.DecipherCCM.md#_construct)
- [\_destroy](crypto._node_crypto_.DecipherCCM.md#_destroy)
- [\_final](crypto._node_crypto_.DecipherCCM.md#_final)
- [\_flush](crypto._node_crypto_.DecipherCCM.md#_flush)
- [\_read](crypto._node_crypto_.DecipherCCM.md#_read)
- [\_transform](crypto._node_crypto_.DecipherCCM.md#_transform)
- [\_write](crypto._node_crypto_.DecipherCCM.md#_write)
- [\_writev](crypto._node_crypto_.DecipherCCM.md#_writev)
- [abort](crypto._node_crypto_.DecipherCCM.md#abort)
- [addListener](crypto._node_crypto_.DecipherCCM.md#addlistener)
- [cancel](crypto._node_crypto_.DecipherCCM.md#cancel)
- [close](crypto._node_crypto_.DecipherCCM.md#close)
- [cork](crypto._node_crypto_.DecipherCCM.md#cork)
- [destroy](crypto._node_crypto_.DecipherCCM.md#destroy)
- [emit](crypto._node_crypto_.DecipherCCM.md#emit)
- [end](crypto._node_crypto_.DecipherCCM.md#end)
- [eventNames](crypto._node_crypto_.DecipherCCM.md#eventnames)
- [final](crypto._node_crypto_.DecipherCCM.md#final)
- [forEach](crypto._node_crypto_.DecipherCCM.md#foreach)
- [getMaxListeners](crypto._node_crypto_.DecipherCCM.md#getmaxlisteners)
- [getReader](crypto._node_crypto_.DecipherCCM.md#getreader)
- [getWriter](crypto._node_crypto_.DecipherCCM.md#getwriter)
- [isPaused](crypto._node_crypto_.DecipherCCM.md#ispaused)
- [listenerCount](crypto._node_crypto_.DecipherCCM.md#listenercount)
- [listeners](crypto._node_crypto_.DecipherCCM.md#listeners)
- [off](crypto._node_crypto_.DecipherCCM.md#off)
- [on](crypto._node_crypto_.DecipherCCM.md#on)
- [once](crypto._node_crypto_.DecipherCCM.md#once)
- [pause](crypto._node_crypto_.DecipherCCM.md#pause)
- [pipe](crypto._node_crypto_.DecipherCCM.md#pipe)
- [pipeThrough](crypto._node_crypto_.DecipherCCM.md#pipethrough)
- [pipeTo](crypto._node_crypto_.DecipherCCM.md#pipeto)
- [prependListener](crypto._node_crypto_.DecipherCCM.md#prependlistener)
- [prependOnceListener](crypto._node_crypto_.DecipherCCM.md#prependoncelistener)
- [push](crypto._node_crypto_.DecipherCCM.md#push)
- [rawListeners](crypto._node_crypto_.DecipherCCM.md#rawlisteners)
- [read](crypto._node_crypto_.DecipherCCM.md#read)
- [removeAllListeners](crypto._node_crypto_.DecipherCCM.md#removealllisteners)
- [removeListener](crypto._node_crypto_.DecipherCCM.md#removelistener)
- [resume](crypto._node_crypto_.DecipherCCM.md#resume)
- [setAAD](crypto._node_crypto_.DecipherCCM.md#setaad)
- [setAuthTag](crypto._node_crypto_.DecipherCCM.md#setauthtag)
- [setAutoPadding](crypto._node_crypto_.DecipherCCM.md#setautopadding)
- [setDefaultEncoding](crypto._node_crypto_.DecipherCCM.md#setdefaultencoding)
- [setEncoding](crypto._node_crypto_.DecipherCCM.md#setencoding)
- [setMaxListeners](crypto._node_crypto_.DecipherCCM.md#setmaxlisteners)
- [tee](crypto._node_crypto_.DecipherCCM.md#tee)
- [uncork](crypto._node_crypto_.DecipherCCM.md#uncork)
- [unpipe](crypto._node_crypto_.DecipherCCM.md#unpipe)
- [unshift](crypto._node_crypto_.DecipherCCM.md#unshift)
- [update](crypto._node_crypto_.DecipherCCM.md#update)
- [wrap](crypto._node_crypto_.DecipherCCM.md#wrap)
- [write](crypto._node_crypto_.DecipherCCM.md#write)
...
▸ **addListener**(`event`, `listener`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
[`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
The buffered data will be flushed when either the [uncork](crypto._node_crypto_.DecipherCCM.md#uncork) or [end](crypto._node_crypto_.DecipherCCM.md#end) methods are called.
...
▸ **destroy**(`error?`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
▸ **end**(`cb?`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
Calling the [write](crypto._node_crypto_.DecipherCCM.md#write) method after calling [end](crypto._node_crypto_.DecipherCCM.md#end) will raise an error.
...
▸ **end**(`chunk`, `cb?`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
▸ **end**(`chunk`, `encoding?`, `cb?`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
▸ **off**(`eventName`, `listener`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
▸ **on**(`event`, `listener`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
▸ **once**(`event`, `listener`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
▸ **pause**(): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
▸ **prependListener**(`event`, `listener`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
▸ **prependOnceListener**(`event`, `listener`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
Calling [read](crypto._node_crypto_.DecipherCCM.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
▸ **removeListener**(`event`, `listener`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
▸ **resume**(): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
▸ **setAAD**(`buffer`, `options`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
[crypto.d.ts:1224](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/crypto.d.ts#L1224)

___

### setAuthTag

▸ **setAuthTag**(`buffer`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
[crypto.d.ts:1223](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/crypto.d.ts#L1223)

___

### setAutoPadding

▸ **setAutoPadding**(`auto_padding?`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
▸ **setDefaultEncoding**(`encoding`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
▸ **setEncoding**(`encoding`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
▸ **setMaxListeners**(`n`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._node_crypto_.DecipherCCM.md#cork) was called.
...
▸ **unpipe**(`destination?`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](crypto._node_crypto_.DecipherCCM.md#pipe) method.
...
Unlike [push](crypto._node_crypto_.DecipherCCM.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto._node_crypto_.DecipherCCM.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto._node_crypto_.DecipherCCM.md#push) will reset the reading state appropriately,
...
▸ **wrap**(`stream`): [`DecipherCCM`](crypto._crypto_.DecipherCCM.md)

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](crypto._node_crypto_.DecipherCCM.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._node_crypto_.DecipherCCM.md#pipe). However, if calling `write()` is preferred, it is
