...
[crypto](../modules/crypto.md).["crypto"](../modules/crypto._crypto_.md).CipherGCM
...
- [allowHalfOpen](crypto._crypto_.CipherGCM.md#allowhalfopen)
- [destroyed](crypto._crypto_.CipherGCM.md#destroyed)
- [locked](crypto._crypto_.CipherGCM.md#locked)
- [readable](crypto._crypto_.CipherGCM.md#readable)
- [readableAborted](crypto._crypto_.CipherGCM.md#readableaborted)
- [readableEncoding](crypto._crypto_.CipherGCM.md#readableencoding)
- [readableEnded](crypto._crypto_.CipherGCM.md#readableended)
- [readableFlowing](crypto._crypto_.CipherGCM.md#readableflowing)
- [readableHighWaterMark](crypto._crypto_.CipherGCM.md#readablehighwatermark)
- [readableLength](crypto._crypto_.CipherGCM.md#readablelength)
- [readableObjectMode](crypto._crypto_.CipherGCM.md#readableobjectmode)
- [writable](crypto._crypto_.CipherGCM.md#writable)
- [writableCorked](crypto._crypto_.CipherGCM.md#writablecorked)
- [writableEnded](crypto._crypto_.CipherGCM.md#writableended)
- [writableFinished](crypto._crypto_.CipherGCM.md#writablefinished)
- [writableHighWaterMark](crypto._crypto_.CipherGCM.md#writablehighwatermark)
- [writableLength](crypto._crypto_.CipherGCM.md#writablelength)
- [writableObjectMode](crypto._crypto_.CipherGCM.md#writableobjectmode)

### Methods

- [[asyncIterator]](crypto._crypto_.CipherGCM.md#[asynciterator])
- [\_construct](crypto._crypto_.CipherGCM.md#_construct)
- [\_destroy](crypto._crypto_.CipherGCM.md#_destroy)
- [\_final](crypto._crypto_.CipherGCM.md#_final)
- [\_flush](crypto._crypto_.CipherGCM.md#_flush)
- [\_read](crypto._crypto_.CipherGCM.md#_read)
- [\_transform](crypto._crypto_.CipherGCM.md#_transform)
- [\_write](crypto._crypto_.CipherGCM.md#_write)
- [\_writev](crypto._crypto_.CipherGCM.md#_writev)
- [abort](crypto._crypto_.CipherGCM.md#abort)
- [addListener](crypto._crypto_.CipherGCM.md#addlistener)
- [cancel](crypto._crypto_.CipherGCM.md#cancel)
- [close](crypto._crypto_.CipherGCM.md#close)
- [cork](crypto._crypto_.CipherGCM.md#cork)
- [destroy](crypto._crypto_.CipherGCM.md#destroy)
- [emit](crypto._crypto_.CipherGCM.md#emit)
- [end](crypto._crypto_.CipherGCM.md#end)
- [eventNames](crypto._crypto_.CipherGCM.md#eventnames)
- [final](crypto._crypto_.CipherGCM.md#final)
- [forEach](crypto._crypto_.CipherGCM.md#foreach)
- [getAuthTag](crypto._crypto_.CipherGCM.md#getauthtag)
- [getMaxListeners](crypto._crypto_.CipherGCM.md#getmaxlisteners)
- [getReader](crypto._crypto_.CipherGCM.md#getreader)
- [getWriter](crypto._crypto_.CipherGCM.md#getwriter)
- [isPaused](crypto._crypto_.CipherGCM.md#ispaused)
- [listenerCount](crypto._crypto_.CipherGCM.md#listenercount)
- [listeners](crypto._crypto_.CipherGCM.md#listeners)
- [off](crypto._crypto_.CipherGCM.md#off)
- [on](crypto._crypto_.CipherGCM.md#on)
- [once](crypto._crypto_.CipherGCM.md#once)
- [pause](crypto._crypto_.CipherGCM.md#pause)
- [pipe](crypto._crypto_.CipherGCM.md#pipe)
- [pipeThrough](crypto._crypto_.CipherGCM.md#pipethrough)
- [pipeTo](crypto._crypto_.CipherGCM.md#pipeto)
- [prependListener](crypto._crypto_.CipherGCM.md#prependlistener)
- [prependOnceListener](crypto._crypto_.CipherGCM.md#prependoncelistener)
- [push](crypto._crypto_.CipherGCM.md#push)
- [rawListeners](crypto._crypto_.CipherGCM.md#rawlisteners)
- [read](crypto._crypto_.CipherGCM.md#read)
- [removeAllListeners](crypto._crypto_.CipherGCM.md#removealllisteners)
- [removeListener](crypto._crypto_.CipherGCM.md#removelistener)
- [resume](crypto._crypto_.CipherGCM.md#resume)
- [setAAD](crypto._crypto_.CipherGCM.md#setaad)
- [setAutoPadding](crypto._crypto_.CipherGCM.md#setautopadding)
- [setDefaultEncoding](crypto._crypto_.CipherGCM.md#setdefaultencoding)
- [setEncoding](crypto._crypto_.CipherGCM.md#setencoding)
- [setMaxListeners](crypto._crypto_.CipherGCM.md#setmaxlisteners)
- [tee](crypto._crypto_.CipherGCM.md#tee)
- [uncork](crypto._crypto_.CipherGCM.md#uncork)
- [unpipe](crypto._crypto_.CipherGCM.md#unpipe)
- [unshift](crypto._crypto_.CipherGCM.md#unshift)
- [update](crypto._crypto_.CipherGCM.md#update)
- [wrap](crypto._crypto_.CipherGCM.md#wrap)
- [write](crypto._crypto_.CipherGCM.md#write)
...
The buffered data will be flushed when either the [uncork](crypto._crypto_.CipherGCM.md#uncork) or [end](crypto._crypto_.CipherGCM.md#end) methods are called.
...
Calling the [write](crypto._crypto_.CipherGCM.md#write) method after calling [end](crypto._crypto_.CipherGCM.md#end) will raise an error.
...
Calling [read](crypto._crypto_.CipherGCM.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._crypto_.CipherGCM.md#cork) was called.
...
using the [pipe](crypto._crypto_.CipherGCM.md#pipe) method.
...
Unlike [push](crypto._crypto_.CipherGCM.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto._crypto_.CipherGCM.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto._crypto_.CipherGCM.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto._crypto_.CipherGCM.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._crypto_.CipherGCM.md#pipe). However, if calling `write()` is preferred, it is
