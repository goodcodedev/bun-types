...
[crypto](../modules/crypto.md).["node:crypto"](../modules/crypto._node_crypto_.md).DecipherOCB
...
- [allowHalfOpen](crypto._node_crypto_.DecipherOCB.md#allowhalfopen)
- [destroyed](crypto._node_crypto_.DecipherOCB.md#destroyed)
- [locked](crypto._node_crypto_.DecipherOCB.md#locked)
- [readable](crypto._node_crypto_.DecipherOCB.md#readable)
- [readableAborted](crypto._node_crypto_.DecipherOCB.md#readableaborted)
- [readableEncoding](crypto._node_crypto_.DecipherOCB.md#readableencoding)
- [readableEnded](crypto._node_crypto_.DecipherOCB.md#readableended)
- [readableFlowing](crypto._node_crypto_.DecipherOCB.md#readableflowing)
- [readableHighWaterMark](crypto._node_crypto_.DecipherOCB.md#readablehighwatermark)
- [readableLength](crypto._node_crypto_.DecipherOCB.md#readablelength)
- [readableObjectMode](crypto._node_crypto_.DecipherOCB.md#readableobjectmode)
- [writable](crypto._node_crypto_.DecipherOCB.md#writable)
- [writableCorked](crypto._node_crypto_.DecipherOCB.md#writablecorked)
- [writableEnded](crypto._node_crypto_.DecipherOCB.md#writableended)
- [writableFinished](crypto._node_crypto_.DecipherOCB.md#writablefinished)
- [writableHighWaterMark](crypto._node_crypto_.DecipherOCB.md#writablehighwatermark)
- [writableLength](crypto._node_crypto_.DecipherOCB.md#writablelength)
- [writableObjectMode](crypto._node_crypto_.DecipherOCB.md#writableobjectmode)

### Methods

- [[asyncIterator]](crypto._node_crypto_.DecipherOCB.md#[asynciterator])
- [\_construct](crypto._node_crypto_.DecipherOCB.md#_construct)
- [\_destroy](crypto._node_crypto_.DecipherOCB.md#_destroy)
- [\_final](crypto._node_crypto_.DecipherOCB.md#_final)
- [\_flush](crypto._node_crypto_.DecipherOCB.md#_flush)
- [\_read](crypto._node_crypto_.DecipherOCB.md#_read)
- [\_transform](crypto._node_crypto_.DecipherOCB.md#_transform)
- [\_write](crypto._node_crypto_.DecipherOCB.md#_write)
- [\_writev](crypto._node_crypto_.DecipherOCB.md#_writev)
- [abort](crypto._node_crypto_.DecipherOCB.md#abort)
- [addListener](crypto._node_crypto_.DecipherOCB.md#addlistener)
- [cancel](crypto._node_crypto_.DecipherOCB.md#cancel)
- [close](crypto._node_crypto_.DecipherOCB.md#close)
- [cork](crypto._node_crypto_.DecipherOCB.md#cork)
- [destroy](crypto._node_crypto_.DecipherOCB.md#destroy)
- [emit](crypto._node_crypto_.DecipherOCB.md#emit)
- [end](crypto._node_crypto_.DecipherOCB.md#end)
- [eventNames](crypto._node_crypto_.DecipherOCB.md#eventnames)
- [final](crypto._node_crypto_.DecipherOCB.md#final)
- [forEach](crypto._node_crypto_.DecipherOCB.md#foreach)
- [getMaxListeners](crypto._node_crypto_.DecipherOCB.md#getmaxlisteners)
- [getReader](crypto._node_crypto_.DecipherOCB.md#getreader)
- [getWriter](crypto._node_crypto_.DecipherOCB.md#getwriter)
- [isPaused](crypto._node_crypto_.DecipherOCB.md#ispaused)
- [listenerCount](crypto._node_crypto_.DecipherOCB.md#listenercount)
- [listeners](crypto._node_crypto_.DecipherOCB.md#listeners)
- [off](crypto._node_crypto_.DecipherOCB.md#off)
- [on](crypto._node_crypto_.DecipherOCB.md#on)
- [once](crypto._node_crypto_.DecipherOCB.md#once)
- [pause](crypto._node_crypto_.DecipherOCB.md#pause)
- [pipe](crypto._node_crypto_.DecipherOCB.md#pipe)
- [pipeThrough](crypto._node_crypto_.DecipherOCB.md#pipethrough)
- [pipeTo](crypto._node_crypto_.DecipherOCB.md#pipeto)
- [prependListener](crypto._node_crypto_.DecipherOCB.md#prependlistener)
- [prependOnceListener](crypto._node_crypto_.DecipherOCB.md#prependoncelistener)
- [push](crypto._node_crypto_.DecipherOCB.md#push)
- [rawListeners](crypto._node_crypto_.DecipherOCB.md#rawlisteners)
- [read](crypto._node_crypto_.DecipherOCB.md#read)
- [removeAllListeners](crypto._node_crypto_.DecipherOCB.md#removealllisteners)
- [removeListener](crypto._node_crypto_.DecipherOCB.md#removelistener)
- [resume](crypto._node_crypto_.DecipherOCB.md#resume)
- [setAAD](crypto._node_crypto_.DecipherOCB.md#setaad)
- [setAuthTag](crypto._node_crypto_.DecipherOCB.md#setauthtag)
- [setAutoPadding](crypto._node_crypto_.DecipherOCB.md#setautopadding)
- [setDefaultEncoding](crypto._node_crypto_.DecipherOCB.md#setdefaultencoding)
- [setEncoding](crypto._node_crypto_.DecipherOCB.md#setencoding)
- [setMaxListeners](crypto._node_crypto_.DecipherOCB.md#setmaxlisteners)
- [tee](crypto._node_crypto_.DecipherOCB.md#tee)
- [uncork](crypto._node_crypto_.DecipherOCB.md#uncork)
- [unpipe](crypto._node_crypto_.DecipherOCB.md#unpipe)
- [unshift](crypto._node_crypto_.DecipherOCB.md#unshift)
- [update](crypto._node_crypto_.DecipherOCB.md#update)
- [wrap](crypto._node_crypto_.DecipherOCB.md#wrap)
- [write](crypto._node_crypto_.DecipherOCB.md#write)
...
▸ **addListener**(`event`, `listener`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
[`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
The buffered data will be flushed when either the [uncork](crypto._node_crypto_.DecipherOCB.md#uncork) or [end](crypto._node_crypto_.DecipherOCB.md#end) methods are called.
...
▸ **destroy**(`error?`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
▸ **end**(`cb?`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
Calling the [write](crypto._node_crypto_.DecipherOCB.md#write) method after calling [end](crypto._node_crypto_.DecipherOCB.md#end) will raise an error.
...
▸ **end**(`chunk`, `cb?`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
▸ **end**(`chunk`, `encoding?`, `cb?`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
▸ **off**(`eventName`, `listener`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
▸ **on**(`event`, `listener`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
▸ **once**(`event`, `listener`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
▸ **pause**(): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
▸ **prependListener**(`event`, `listener`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
▸ **prependOnceListener**(`event`, `listener`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
Calling [read](crypto._node_crypto_.DecipherOCB.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
▸ **removeListener**(`event`, `listener`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
▸ **resume**(): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
▸ **setAAD**(`buffer`, `options?`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
[crypto.d.ts:1242](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/crypto.d.ts#L1242)

___

### setAuthTag

▸ **setAuthTag**(`buffer`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
[crypto.d.ts:1241](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/crypto.d.ts#L1241)

___

### setAutoPadding

▸ **setAutoPadding**(`auto_padding?`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
▸ **setDefaultEncoding**(`encoding`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
▸ **setEncoding**(`encoding`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
▸ **setMaxListeners**(`n`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._node_crypto_.DecipherOCB.md#cork) was called.
...
▸ **unpipe**(`destination?`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](crypto._node_crypto_.DecipherOCB.md#pipe) method.
...
Unlike [push](crypto._node_crypto_.DecipherOCB.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto._node_crypto_.DecipherOCB.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto._node_crypto_.DecipherOCB.md#push) will reset the reading state appropriately,
...
▸ **wrap**(`stream`): [`DecipherOCB`](crypto._crypto_.DecipherOCB.md)

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](crypto._node_crypto_.DecipherOCB.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._node_crypto_.DecipherOCB.md#pipe). However, if calling `write()` is preferred, it is
