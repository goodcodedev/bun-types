...
[crypto](../modules/crypto.md).["crypto"](../modules/crypto._crypto_.md).CipherCCM
...
- [allowHalfOpen](crypto._crypto_.CipherCCM.md#allowhalfopen)
- [destroyed](crypto._crypto_.CipherCCM.md#destroyed)
- [locked](crypto._crypto_.CipherCCM.md#locked)
- [readable](crypto._crypto_.CipherCCM.md#readable)
- [readableAborted](crypto._crypto_.CipherCCM.md#readableaborted)
- [readableEncoding](crypto._crypto_.CipherCCM.md#readableencoding)
- [readableEnded](crypto._crypto_.CipherCCM.md#readableended)
- [readableFlowing](crypto._crypto_.CipherCCM.md#readableflowing)
- [readableHighWaterMark](crypto._crypto_.CipherCCM.md#readablehighwatermark)
- [readableLength](crypto._crypto_.CipherCCM.md#readablelength)
- [readableObjectMode](crypto._crypto_.CipherCCM.md#readableobjectmode)
- [writable](crypto._crypto_.CipherCCM.md#writable)
- [writableCorked](crypto._crypto_.CipherCCM.md#writablecorked)
- [writableEnded](crypto._crypto_.CipherCCM.md#writableended)
- [writableFinished](crypto._crypto_.CipherCCM.md#writablefinished)
- [writableHighWaterMark](crypto._crypto_.CipherCCM.md#writablehighwatermark)
- [writableLength](crypto._crypto_.CipherCCM.md#writablelength)
- [writableObjectMode](crypto._crypto_.CipherCCM.md#writableobjectmode)

### Methods

- [[asyncIterator]](crypto._crypto_.CipherCCM.md#[asynciterator])
- [\_construct](crypto._crypto_.CipherCCM.md#_construct)
- [\_destroy](crypto._crypto_.CipherCCM.md#_destroy)
- [\_final](crypto._crypto_.CipherCCM.md#_final)
- [\_flush](crypto._crypto_.CipherCCM.md#_flush)
- [\_read](crypto._crypto_.CipherCCM.md#_read)
- [\_transform](crypto._crypto_.CipherCCM.md#_transform)
- [\_write](crypto._crypto_.CipherCCM.md#_write)
- [\_writev](crypto._crypto_.CipherCCM.md#_writev)
- [abort](crypto._crypto_.CipherCCM.md#abort)
- [addListener](crypto._crypto_.CipherCCM.md#addlistener)
- [cancel](crypto._crypto_.CipherCCM.md#cancel)
- [close](crypto._crypto_.CipherCCM.md#close)
- [cork](crypto._crypto_.CipherCCM.md#cork)
- [destroy](crypto._crypto_.CipherCCM.md#destroy)
- [emit](crypto._crypto_.CipherCCM.md#emit)
- [end](crypto._crypto_.CipherCCM.md#end)
- [eventNames](crypto._crypto_.CipherCCM.md#eventnames)
- [final](crypto._crypto_.CipherCCM.md#final)
- [forEach](crypto._crypto_.CipherCCM.md#foreach)
- [getAuthTag](crypto._crypto_.CipherCCM.md#getauthtag)
- [getMaxListeners](crypto._crypto_.CipherCCM.md#getmaxlisteners)
- [getReader](crypto._crypto_.CipherCCM.md#getreader)
- [getWriter](crypto._crypto_.CipherCCM.md#getwriter)
- [isPaused](crypto._crypto_.CipherCCM.md#ispaused)
- [listenerCount](crypto._crypto_.CipherCCM.md#listenercount)
- [listeners](crypto._crypto_.CipherCCM.md#listeners)
- [off](crypto._crypto_.CipherCCM.md#off)
- [on](crypto._crypto_.CipherCCM.md#on)
- [once](crypto._crypto_.CipherCCM.md#once)
- [pause](crypto._crypto_.CipherCCM.md#pause)
- [pipe](crypto._crypto_.CipherCCM.md#pipe)
- [pipeThrough](crypto._crypto_.CipherCCM.md#pipethrough)
- [pipeTo](crypto._crypto_.CipherCCM.md#pipeto)
- [prependListener](crypto._crypto_.CipherCCM.md#prependlistener)
- [prependOnceListener](crypto._crypto_.CipherCCM.md#prependoncelistener)
- [push](crypto._crypto_.CipherCCM.md#push)
- [rawListeners](crypto._crypto_.CipherCCM.md#rawlisteners)
- [read](crypto._crypto_.CipherCCM.md#read)
- [removeAllListeners](crypto._crypto_.CipherCCM.md#removealllisteners)
- [removeListener](crypto._crypto_.CipherCCM.md#removelistener)
- [resume](crypto._crypto_.CipherCCM.md#resume)
- [setAAD](crypto._crypto_.CipherCCM.md#setaad)
- [setAutoPadding](crypto._crypto_.CipherCCM.md#setautopadding)
- [setDefaultEncoding](crypto._crypto_.CipherCCM.md#setdefaultencoding)
- [setEncoding](crypto._crypto_.CipherCCM.md#setencoding)
- [setMaxListeners](crypto._crypto_.CipherCCM.md#setmaxlisteners)
- [tee](crypto._crypto_.CipherCCM.md#tee)
- [uncork](crypto._crypto_.CipherCCM.md#uncork)
- [unpipe](crypto._crypto_.CipherCCM.md#unpipe)
- [unshift](crypto._crypto_.CipherCCM.md#unshift)
- [update](crypto._crypto_.CipherCCM.md#update)
- [wrap](crypto._crypto_.CipherCCM.md#wrap)
- [write](crypto._crypto_.CipherCCM.md#write)
...
The buffered data will be flushed when either the [uncork](crypto._crypto_.CipherCCM.md#uncork) or [end](crypto._crypto_.CipherCCM.md#end) methods are called.
...
Calling the [write](crypto._crypto_.CipherCCM.md#write) method after calling [end](crypto._crypto_.CipherCCM.md#end) will raise an error.
...
Calling [read](crypto._crypto_.CipherCCM.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._crypto_.CipherCCM.md#cork) was called.
...
using the [pipe](crypto._crypto_.CipherCCM.md#pipe) method.
...
Unlike [push](crypto._crypto_.CipherCCM.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto._crypto_.CipherCCM.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto._crypto_.CipherCCM.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto._crypto_.CipherCCM.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._crypto_.CipherCCM.md#pipe). However, if calling `write()` is preferred, it is
