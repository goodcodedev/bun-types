...
[crypto](../modules/crypto.md).["node:crypto"](../modules/crypto._node_crypto_.md).DecipherGCM
...
- [allowHalfOpen](crypto._node_crypto_.DecipherGCM.md#allowhalfopen)
- [destroyed](crypto._node_crypto_.DecipherGCM.md#destroyed)
- [locked](crypto._node_crypto_.DecipherGCM.md#locked)
- [readable](crypto._node_crypto_.DecipherGCM.md#readable)
- [readableAborted](crypto._node_crypto_.DecipherGCM.md#readableaborted)
- [readableEncoding](crypto._node_crypto_.DecipherGCM.md#readableencoding)
- [readableEnded](crypto._node_crypto_.DecipherGCM.md#readableended)
- [readableFlowing](crypto._node_crypto_.DecipherGCM.md#readableflowing)
- [readableHighWaterMark](crypto._node_crypto_.DecipherGCM.md#readablehighwatermark)
- [readableLength](crypto._node_crypto_.DecipherGCM.md#readablelength)
- [readableObjectMode](crypto._node_crypto_.DecipherGCM.md#readableobjectmode)
- [writable](crypto._node_crypto_.DecipherGCM.md#writable)
- [writableCorked](crypto._node_crypto_.DecipherGCM.md#writablecorked)
- [writableEnded](crypto._node_crypto_.DecipherGCM.md#writableended)
- [writableFinished](crypto._node_crypto_.DecipherGCM.md#writablefinished)
- [writableHighWaterMark](crypto._node_crypto_.DecipherGCM.md#writablehighwatermark)
- [writableLength](crypto._node_crypto_.DecipherGCM.md#writablelength)
- [writableObjectMode](crypto._node_crypto_.DecipherGCM.md#writableobjectmode)

### Methods

- [[asyncIterator]](crypto._node_crypto_.DecipherGCM.md#[asynciterator])
- [\_construct](crypto._node_crypto_.DecipherGCM.md#_construct)
- [\_destroy](crypto._node_crypto_.DecipherGCM.md#_destroy)
- [\_final](crypto._node_crypto_.DecipherGCM.md#_final)
- [\_flush](crypto._node_crypto_.DecipherGCM.md#_flush)
- [\_read](crypto._node_crypto_.DecipherGCM.md#_read)
- [\_transform](crypto._node_crypto_.DecipherGCM.md#_transform)
- [\_write](crypto._node_crypto_.DecipherGCM.md#_write)
- [\_writev](crypto._node_crypto_.DecipherGCM.md#_writev)
- [abort](crypto._node_crypto_.DecipherGCM.md#abort)
- [addListener](crypto._node_crypto_.DecipherGCM.md#addlistener)
- [cancel](crypto._node_crypto_.DecipherGCM.md#cancel)
- [close](crypto._node_crypto_.DecipherGCM.md#close)
- [cork](crypto._node_crypto_.DecipherGCM.md#cork)
- [destroy](crypto._node_crypto_.DecipherGCM.md#destroy)
- [emit](crypto._node_crypto_.DecipherGCM.md#emit)
- [end](crypto._node_crypto_.DecipherGCM.md#end)
- [eventNames](crypto._node_crypto_.DecipherGCM.md#eventnames)
- [final](crypto._node_crypto_.DecipherGCM.md#final)
- [forEach](crypto._node_crypto_.DecipherGCM.md#foreach)
- [getMaxListeners](crypto._node_crypto_.DecipherGCM.md#getmaxlisteners)
- [getReader](crypto._node_crypto_.DecipherGCM.md#getreader)
- [getWriter](crypto._node_crypto_.DecipherGCM.md#getwriter)
- [isPaused](crypto._node_crypto_.DecipherGCM.md#ispaused)
- [listenerCount](crypto._node_crypto_.DecipherGCM.md#listenercount)
- [listeners](crypto._node_crypto_.DecipherGCM.md#listeners)
- [off](crypto._node_crypto_.DecipherGCM.md#off)
- [on](crypto._node_crypto_.DecipherGCM.md#on)
- [once](crypto._node_crypto_.DecipherGCM.md#once)
- [pause](crypto._node_crypto_.DecipherGCM.md#pause)
- [pipe](crypto._node_crypto_.DecipherGCM.md#pipe)
- [pipeThrough](crypto._node_crypto_.DecipherGCM.md#pipethrough)
- [pipeTo](crypto._node_crypto_.DecipherGCM.md#pipeto)
- [prependListener](crypto._node_crypto_.DecipherGCM.md#prependlistener)
- [prependOnceListener](crypto._node_crypto_.DecipherGCM.md#prependoncelistener)
- [push](crypto._node_crypto_.DecipherGCM.md#push)
- [rawListeners](crypto._node_crypto_.DecipherGCM.md#rawlisteners)
- [read](crypto._node_crypto_.DecipherGCM.md#read)
- [removeAllListeners](crypto._node_crypto_.DecipherGCM.md#removealllisteners)
- [removeListener](crypto._node_crypto_.DecipherGCM.md#removelistener)
- [resume](crypto._node_crypto_.DecipherGCM.md#resume)
- [setAAD](crypto._node_crypto_.DecipherGCM.md#setaad)
- [setAuthTag](crypto._node_crypto_.DecipherGCM.md#setauthtag)
- [setAutoPadding](crypto._node_crypto_.DecipherGCM.md#setautopadding)
- [setDefaultEncoding](crypto._node_crypto_.DecipherGCM.md#setdefaultencoding)
- [setEncoding](crypto._node_crypto_.DecipherGCM.md#setencoding)
- [setMaxListeners](crypto._node_crypto_.DecipherGCM.md#setmaxlisteners)
- [tee](crypto._node_crypto_.DecipherGCM.md#tee)
- [uncork](crypto._node_crypto_.DecipherGCM.md#uncork)
- [unpipe](crypto._node_crypto_.DecipherGCM.md#unpipe)
- [unshift](crypto._node_crypto_.DecipherGCM.md#unshift)
- [update](crypto._node_crypto_.DecipherGCM.md#update)
- [wrap](crypto._node_crypto_.DecipherGCM.md#wrap)
- [write](crypto._node_crypto_.DecipherGCM.md#write)
...
The buffered data will be flushed when either the [uncork](crypto._node_crypto_.DecipherGCM.md#uncork) or [end](crypto._node_crypto_.DecipherGCM.md#end) methods are called.
...
Calling the [write](crypto._node_crypto_.DecipherGCM.md#write) method after calling [end](crypto._node_crypto_.DecipherGCM.md#end) will raise an error.
...
Calling [read](crypto._node_crypto_.DecipherGCM.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._node_crypto_.DecipherGCM.md#cork) was called.
...
using the [pipe](crypto._node_crypto_.DecipherGCM.md#pipe) method.
...
Unlike [push](crypto._node_crypto_.DecipherGCM.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto._node_crypto_.DecipherGCM.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto._node_crypto_.DecipherGCM.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto._node_crypto_.DecipherGCM.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._node_crypto_.DecipherGCM.md#pipe). However, if calling `write()` is preferred, it is
