...
[crypto](../modules/crypto.md).["crypto"](../modules/crypto._crypto_.md).DecipherOCB
...
- [allowHalfOpen](crypto._crypto_.DecipherOCB.md#allowhalfopen)
- [destroyed](crypto._crypto_.DecipherOCB.md#destroyed)
- [locked](crypto._crypto_.DecipherOCB.md#locked)
- [readable](crypto._crypto_.DecipherOCB.md#readable)
- [readableAborted](crypto._crypto_.DecipherOCB.md#readableaborted)
- [readableEncoding](crypto._crypto_.DecipherOCB.md#readableencoding)
- [readableEnded](crypto._crypto_.DecipherOCB.md#readableended)
- [readableFlowing](crypto._crypto_.DecipherOCB.md#readableflowing)
- [readableHighWaterMark](crypto._crypto_.DecipherOCB.md#readablehighwatermark)
- [readableLength](crypto._crypto_.DecipherOCB.md#readablelength)
- [readableObjectMode](crypto._crypto_.DecipherOCB.md#readableobjectmode)
- [writable](crypto._crypto_.DecipherOCB.md#writable)
- [writableCorked](crypto._crypto_.DecipherOCB.md#writablecorked)
- [writableEnded](crypto._crypto_.DecipherOCB.md#writableended)
- [writableFinished](crypto._crypto_.DecipherOCB.md#writablefinished)
- [writableHighWaterMark](crypto._crypto_.DecipherOCB.md#writablehighwatermark)
- [writableLength](crypto._crypto_.DecipherOCB.md#writablelength)
- [writableObjectMode](crypto._crypto_.DecipherOCB.md#writableobjectmode)

### Methods

- [[asyncIterator]](crypto._crypto_.DecipherOCB.md#[asynciterator])
- [\_construct](crypto._crypto_.DecipherOCB.md#_construct)
- [\_destroy](crypto._crypto_.DecipherOCB.md#_destroy)
- [\_final](crypto._crypto_.DecipherOCB.md#_final)
- [\_flush](crypto._crypto_.DecipherOCB.md#_flush)
- [\_read](crypto._crypto_.DecipherOCB.md#_read)
- [\_transform](crypto._crypto_.DecipherOCB.md#_transform)
- [\_write](crypto._crypto_.DecipherOCB.md#_write)
- [\_writev](crypto._crypto_.DecipherOCB.md#_writev)
- [abort](crypto._crypto_.DecipherOCB.md#abort)
- [addListener](crypto._crypto_.DecipherOCB.md#addlistener)
- [cancel](crypto._crypto_.DecipherOCB.md#cancel)
- [close](crypto._crypto_.DecipherOCB.md#close)
- [cork](crypto._crypto_.DecipherOCB.md#cork)
- [destroy](crypto._crypto_.DecipherOCB.md#destroy)
- [emit](crypto._crypto_.DecipherOCB.md#emit)
- [end](crypto._crypto_.DecipherOCB.md#end)
- [eventNames](crypto._crypto_.DecipherOCB.md#eventnames)
- [final](crypto._crypto_.DecipherOCB.md#final)
- [forEach](crypto._crypto_.DecipherOCB.md#foreach)
- [getMaxListeners](crypto._crypto_.DecipherOCB.md#getmaxlisteners)
- [getReader](crypto._crypto_.DecipherOCB.md#getreader)
- [getWriter](crypto._crypto_.DecipherOCB.md#getwriter)
- [isPaused](crypto._crypto_.DecipherOCB.md#ispaused)
- [listenerCount](crypto._crypto_.DecipherOCB.md#listenercount)
- [listeners](crypto._crypto_.DecipherOCB.md#listeners)
- [off](crypto._crypto_.DecipherOCB.md#off)
- [on](crypto._crypto_.DecipherOCB.md#on)
- [once](crypto._crypto_.DecipherOCB.md#once)
- [pause](crypto._crypto_.DecipherOCB.md#pause)
- [pipe](crypto._crypto_.DecipherOCB.md#pipe)
- [pipeThrough](crypto._crypto_.DecipherOCB.md#pipethrough)
- [pipeTo](crypto._crypto_.DecipherOCB.md#pipeto)
- [prependListener](crypto._crypto_.DecipherOCB.md#prependlistener)
- [prependOnceListener](crypto._crypto_.DecipherOCB.md#prependoncelistener)
- [push](crypto._crypto_.DecipherOCB.md#push)
- [rawListeners](crypto._crypto_.DecipherOCB.md#rawlisteners)
- [read](crypto._crypto_.DecipherOCB.md#read)
- [removeAllListeners](crypto._crypto_.DecipherOCB.md#removealllisteners)
- [removeListener](crypto._crypto_.DecipherOCB.md#removelistener)
- [resume](crypto._crypto_.DecipherOCB.md#resume)
- [setAAD](crypto._crypto_.DecipherOCB.md#setaad)
- [setAuthTag](crypto._crypto_.DecipherOCB.md#setauthtag)
- [setAutoPadding](crypto._crypto_.DecipherOCB.md#setautopadding)
- [setDefaultEncoding](crypto._crypto_.DecipherOCB.md#setdefaultencoding)
- [setEncoding](crypto._crypto_.DecipherOCB.md#setencoding)
- [setMaxListeners](crypto._crypto_.DecipherOCB.md#setmaxlisteners)
- [tee](crypto._crypto_.DecipherOCB.md#tee)
- [uncork](crypto._crypto_.DecipherOCB.md#uncork)
- [unpipe](crypto._crypto_.DecipherOCB.md#unpipe)
- [unshift](crypto._crypto_.DecipherOCB.md#unshift)
- [update](crypto._crypto_.DecipherOCB.md#update)
- [wrap](crypto._crypto_.DecipherOCB.md#wrap)
- [write](crypto._crypto_.DecipherOCB.md#write)
...
The buffered data will be flushed when either the [uncork](crypto._crypto_.DecipherOCB.md#uncork) or [end](crypto._crypto_.DecipherOCB.md#end) methods are called.
...
Calling the [write](crypto._crypto_.DecipherOCB.md#write) method after calling [end](crypto._crypto_.DecipherOCB.md#end) will raise an error.
...
Calling [read](crypto._crypto_.DecipherOCB.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._crypto_.DecipherOCB.md#cork) was called.
...
using the [pipe](crypto._crypto_.DecipherOCB.md#pipe) method.
...
Unlike [push](crypto._crypto_.DecipherOCB.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto._crypto_.DecipherOCB.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto._crypto_.DecipherOCB.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto._crypto_.DecipherOCB.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._crypto_.DecipherOCB.md#pipe). However, if calling `write()` is preferred, it is
