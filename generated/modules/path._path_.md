...
- [posix](path._path_.md#posix)
- [win32](path._path_.md#win32)

### Interfaces

- [FormatInputPathObject](../interfaces/path._path_.FormatInputPathObject.md)
- [ParsedPath](../interfaces/path._path_.ParsedPath.md)

### Variables

- [delimiter](path._path_.md#delimiter)
- [sep](path._path_.md#sep)

### Functions

- [basename](path._path_.md#basename)
- [dirname](path._path_.md#dirname)
- [extname](path._path_.md#extname)
- [format](path._path_.md#format)
- [isAbsolute](path._path_.md#isabsolute)
- [join](path._path_.md#join)
- [normalize](path._path_.md#normalize)
- [parse](path._path_.md#parse)
- [relative](path._path_.md#relative)
- [resolve](path._path_.md#resolve)
- [toNamespacedPath](path._path_.md#tonamespacedpath)
...
Renames and re-exports [&quot;path/win32&quot;](path._path_win32_.md)
