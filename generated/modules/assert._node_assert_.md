...
[assert](assert.md)."node:assert"

## Table of contents

### Classes

- [AssertionError](../classes/assert._node_assert_.AssertionError.md)
- [CallTracker](../classes/assert._node_assert_.CallTracker.md)

### Interfaces

- [CallTrackerReportInformation](../interfaces/assert._node_assert_.CallTrackerReportInformation.md)

### Type Aliases

- [AssertPredicate](assert._node_assert_.md#assertpredicate)

### Functions

- [deepEqual](assert._node_assert_.md#deepequal)
- [deepStrictEqual](assert._node_assert_.md#deepstrictequal)
- [doesNotReject](assert._node_assert_.md#doesnotreject)
- [doesNotThrow](assert._node_assert_.md#doesnotthrow)
- [equal](assert._node_assert_.md#equal)
- [fail](assert._node_assert_.md#fail)
- [ifError](assert._node_assert_.md#iferror)
- [match](assert._node_assert_.md#match)
- [notDeepEqual](assert._node_assert_.md#notdeepequal)
- [notDeepStrictEqual](assert._node_assert_.md#notdeepstrictequal)
- [notEqual](assert._node_assert_.md#notequal)
- [notStrictEqual](assert._node_assert_.md#notstrictequal)
- [ok](assert._node_assert_.md#ok)
- [rejects](assert._node_assert_.md#rejects)
- [strict](assert._node_assert_.md#strict)
- [strictEqual](assert._node_assert_.md#strictequal)
- [throws](assert._node_assert_.md#throws)
...
An alias of [deepStrictEqual](assert._node_assert_.md#deepstrictequal).

**Legacy assertion mode**

> Stability: 3 - Legacy: Use [deepStrictEqual](assert._node_assert_.md#deepstrictequal) instead.

Tests for deep equality between the `actual` and `expected` parameters. Consider
using [deepStrictEqual](assert._node_assert_.md#deepstrictequal) instead. [deepEqual](assert._node_assert_.md#deepequal) can have
surprising results.
...
function. See [throws](assert._node_assert_.md#throws) for more details.

Besides the async nature to await the completion behaves identically to [doesNotThrow](assert._node_assert_.md#doesnotthrow).
...
An alias of [strictEqual](assert._node_assert_.md#strictequal).

**Legacy assertion mode**

> Stability: 3 - Legacy: Use [strictEqual](assert._node_assert_.md#strictequal) instead.
...
An alias of [notDeepStrictEqual](assert._node_assert_.md#notdeepstrictequal).

**Legacy assertion mode**

> Stability: 3 - Legacy: Use [notDeepStrictEqual](assert._node_assert_.md#notdeepstrictequal) instead.

Tests for any deep inequality. Opposite of [deepEqual](assert._node_assert_.md#deepequal).
...
Tests for deep strict inequality. Opposite of [deepStrictEqual](assert._node_assert_.md#deepstrictequal).
...
An alias of [notStrictEqual](assert._node_assert_.md#notstrictequal).

**Legacy assertion mode**

> Stability: 3 - Legacy: Use [notStrictEqual](assert._node_assert_.md#notstrictequal) instead.
...
Besides the async nature to await the completion behaves identically to [throws](assert._node_assert_.md#throws).
...
example in [throws](assert._node_assert_.md#throws) carefully if using a string as the second
