...
- [fchownSync](fs._node_fs_.md#fchownsync)
...
For detailed information, see the documentation of the asynchronous version of
this API: [readv](fs._node_fs_.md#readv).
...
For detailed information, see the documentation of the asynchronous version of
this API: [realpath](fs._node_fs_.md#realpath).
...
To check if a file exists without manipulating it afterwards, [access](fs._node_fs_.md#access) is recommended.
...
For detailed information, see the documentation of the asynchronous version of
this API: [symlink](fs._node_fs_.md#symlink).
...
directory, use [rmdir](fs._node_fs_.md#rmdir).
...
For detailed information, see the documentation of the asynchronous version of
this API: [utimes](fs._node_fs_.md#utimes).
...
For detailed information, see the documentation of the asynchronous version of
this API: [writeFile](fs._node_fs_.md#writefile).
...
For detailed information, see the documentation of the asynchronous version of
this API: [write](fs._node_fs_.md#write).
...
For detailed information, see the documentation of the asynchronous version of
this API: [writev](fs._node_fs_.md#writev).
