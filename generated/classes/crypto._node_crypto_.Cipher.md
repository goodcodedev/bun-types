...
[crypto](../modules/crypto.md).["node:crypto"](../modules/crypto._node_crypto_.md).Cipher
...
- [constructor](crypto._node_crypto_.Cipher.md#constructor)

### Properties

- [allowHalfOpen](crypto._node_crypto_.Cipher.md#allowhalfopen)
- [destroyed](crypto._node_crypto_.Cipher.md#destroyed)
- [locked](crypto._node_crypto_.Cipher.md#locked)
- [readable](crypto._node_crypto_.Cipher.md#readable)
- [readableAborted](crypto._node_crypto_.Cipher.md#readableaborted)
- [readableEncoding](crypto._node_crypto_.Cipher.md#readableencoding)
- [readableEnded](crypto._node_crypto_.Cipher.md#readableended)
- [readableFlowing](crypto._node_crypto_.Cipher.md#readableflowing)
- [readableHighWaterMark](crypto._node_crypto_.Cipher.md#readablehighwatermark)
- [readableLength](crypto._node_crypto_.Cipher.md#readablelength)
- [readableObjectMode](crypto._node_crypto_.Cipher.md#readableobjectmode)
- [writable](crypto._node_crypto_.Cipher.md#writable)
- [writableCorked](crypto._node_crypto_.Cipher.md#writablecorked)
- [writableEnded](crypto._node_crypto_.Cipher.md#writableended)
- [writableFinished](crypto._node_crypto_.Cipher.md#writablefinished)
- [writableHighWaterMark](crypto._node_crypto_.Cipher.md#writablehighwatermark)
- [writableLength](crypto._node_crypto_.Cipher.md#writablelength)
- [writableObjectMode](crypto._node_crypto_.Cipher.md#writableobjectmode)
- [captureRejectionSymbol](crypto._node_crypto_.Cipher.md#capturerejectionsymbol)
- [captureRejections](crypto._node_crypto_.Cipher.md#capturerejections)
- [defaultMaxListeners](crypto._node_crypto_.Cipher.md#defaultmaxlisteners)
- [errorMonitor](crypto._node_crypto_.Cipher.md#errormonitor)

### Methods

- [[asyncIterator]](crypto._node_crypto_.Cipher.md#[asynciterator])
- [\_construct](crypto._node_crypto_.Cipher.md#_construct)
- [\_destroy](crypto._node_crypto_.Cipher.md#_destroy)
- [\_final](crypto._node_crypto_.Cipher.md#_final)
- [\_flush](crypto._node_crypto_.Cipher.md#_flush)
- [\_read](crypto._node_crypto_.Cipher.md#_read)
- [\_transform](crypto._node_crypto_.Cipher.md#_transform)
- [\_write](crypto._node_crypto_.Cipher.md#_write)
- [\_writev](crypto._node_crypto_.Cipher.md#_writev)
- [abort](crypto._node_crypto_.Cipher.md#abort)
- [addListener](crypto._node_crypto_.Cipher.md#addlistener)
- [cancel](crypto._node_crypto_.Cipher.md#cancel)
- [close](crypto._node_crypto_.Cipher.md#close)
- [cork](crypto._node_crypto_.Cipher.md#cork)
- [destroy](crypto._node_crypto_.Cipher.md#destroy)
- [emit](crypto._node_crypto_.Cipher.md#emit)
- [end](crypto._node_crypto_.Cipher.md#end)
- [eventNames](crypto._node_crypto_.Cipher.md#eventnames)
- [final](crypto._node_crypto_.Cipher.md#final)
- [forEach](crypto._node_crypto_.Cipher.md#foreach)
- [getMaxListeners](crypto._node_crypto_.Cipher.md#getmaxlisteners)
- [getReader](crypto._node_crypto_.Cipher.md#getreader)
- [getWriter](crypto._node_crypto_.Cipher.md#getwriter)
- [isPaused](crypto._node_crypto_.Cipher.md#ispaused)
- [listenerCount](crypto._node_crypto_.Cipher.md#listenercount)
- [listeners](crypto._node_crypto_.Cipher.md#listeners)
- [off](crypto._node_crypto_.Cipher.md#off)
- [on](crypto._node_crypto_.Cipher.md#on)
- [once](crypto._node_crypto_.Cipher.md#once)
- [pause](crypto._node_crypto_.Cipher.md#pause)
- [pipe](crypto._node_crypto_.Cipher.md#pipe)
- [pipeThrough](crypto._node_crypto_.Cipher.md#pipethrough)
- [pipeTo](crypto._node_crypto_.Cipher.md#pipeto)
- [prependListener](crypto._node_crypto_.Cipher.md#prependlistener)
- [prependOnceListener](crypto._node_crypto_.Cipher.md#prependoncelistener)
- [push](crypto._node_crypto_.Cipher.md#push)
- [rawListeners](crypto._node_crypto_.Cipher.md#rawlisteners)
- [read](crypto._node_crypto_.Cipher.md#read)
- [removeAllListeners](crypto._node_crypto_.Cipher.md#removealllisteners)
- [removeListener](crypto._node_crypto_.Cipher.md#removelistener)
- [resume](crypto._node_crypto_.Cipher.md#resume)
- [setAutoPadding](crypto._node_crypto_.Cipher.md#setautopadding)
- [setDefaultEncoding](crypto._node_crypto_.Cipher.md#setdefaultencoding)
- [setEncoding](crypto._node_crypto_.Cipher.md#setencoding)
- [setMaxListeners](crypto._node_crypto_.Cipher.md#setmaxlisteners)
- [tee](crypto._node_crypto_.Cipher.md#tee)
- [uncork](crypto._node_crypto_.Cipher.md#uncork)
- [unpipe](crypto._node_crypto_.Cipher.md#unpipe)
- [unshift](crypto._node_crypto_.Cipher.md#unshift)
- [update](crypto._node_crypto_.Cipher.md#update)
- [wrap](crypto._node_crypto_.Cipher.md#wrap)
- [write](crypto._node_crypto_.Cipher.md#write)
- [from](crypto._node_crypto_.Cipher.md#from)
- [getEventListeners](crypto._node_crypto_.Cipher.md#geteventlisteners)
- [isDisturbed](crypto._node_crypto_.Cipher.md#isdisturbed)
- [listenerCount](crypto._node_crypto_.Cipher.md#listenercount-1)
- [on](crypto._node_crypto_.Cipher.md#on-1)
- [once](crypto._node_crypto_.Cipher.md#once-1)
- [setMaxListeners](crypto._node_crypto_.Cipher.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](crypto._node_crypto_.Cipher.md#uncork) or [end](crypto._node_crypto_.Cipher.md#end) methods are called.
...
Calling the [write](crypto._node_crypto_.Cipher.md#write) method after calling [end](crypto._node_crypto_.Cipher.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](crypto._node_crypto_.Cipher.md#defaultmaxlisteners).
...
Calling [read](crypto._node_crypto_.Cipher.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._node_crypto_.Cipher.md#cork) was called.
...
using the [pipe](crypto._node_crypto_.Cipher.md#pipe) method.
...
Unlike [push](crypto._node_crypto_.Cipher.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto._node_crypto_.Cipher.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto._node_crypto_.Cipher.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto._node_crypto_.Cipher.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._node_crypto_.Cipher.md#pipe). However, if calling `write()` is preferred, it is
