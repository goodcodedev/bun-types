...
[crypto](../modules/crypto.md).["node:crypto"](../modules/crypto._node_crypto_.md).Hmac
...
The [createHmac](../modules/crypto._node_crypto_.md#createhmac) method is used to create `Hmac` instances. `Hmac`objects are not to be created directly using the `new` keyword.
...
- [constructor](crypto._node_crypto_.Hmac.md#constructor)

### Properties

- [allowHalfOpen](crypto._node_crypto_.Hmac.md#allowhalfopen)
- [destroyed](crypto._node_crypto_.Hmac.md#destroyed)
- [locked](crypto._node_crypto_.Hmac.md#locked)
- [readable](crypto._node_crypto_.Hmac.md#readable)
- [readableAborted](crypto._node_crypto_.Hmac.md#readableaborted)
- [readableEncoding](crypto._node_crypto_.Hmac.md#readableencoding)
- [readableEnded](crypto._node_crypto_.Hmac.md#readableended)
- [readableFlowing](crypto._node_crypto_.Hmac.md#readableflowing)
- [readableHighWaterMark](crypto._node_crypto_.Hmac.md#readablehighwatermark)
- [readableLength](crypto._node_crypto_.Hmac.md#readablelength)
- [readableObjectMode](crypto._node_crypto_.Hmac.md#readableobjectmode)
- [writable](crypto._node_crypto_.Hmac.md#writable)
- [writableCorked](crypto._node_crypto_.Hmac.md#writablecorked)
- [writableEnded](crypto._node_crypto_.Hmac.md#writableended)
- [writableFinished](crypto._node_crypto_.Hmac.md#writablefinished)
- [writableHighWaterMark](crypto._node_crypto_.Hmac.md#writablehighwatermark)
- [writableLength](crypto._node_crypto_.Hmac.md#writablelength)
- [writableObjectMode](crypto._node_crypto_.Hmac.md#writableobjectmode)
- [captureRejectionSymbol](crypto._node_crypto_.Hmac.md#capturerejectionsymbol)
- [captureRejections](crypto._node_crypto_.Hmac.md#capturerejections)
- [defaultMaxListeners](crypto._node_crypto_.Hmac.md#defaultmaxlisteners)
- [errorMonitor](crypto._node_crypto_.Hmac.md#errormonitor)

### Methods

- [[asyncIterator]](crypto._node_crypto_.Hmac.md#[asynciterator])
- [\_construct](crypto._node_crypto_.Hmac.md#_construct)
- [\_destroy](crypto._node_crypto_.Hmac.md#_destroy)
- [\_final](crypto._node_crypto_.Hmac.md#_final)
- [\_flush](crypto._node_crypto_.Hmac.md#_flush)
- [\_read](crypto._node_crypto_.Hmac.md#_read)
- [\_transform](crypto._node_crypto_.Hmac.md#_transform)
- [\_write](crypto._node_crypto_.Hmac.md#_write)
- [\_writev](crypto._node_crypto_.Hmac.md#_writev)
- [abort](crypto._node_crypto_.Hmac.md#abort)
- [addListener](crypto._node_crypto_.Hmac.md#addlistener)
- [cancel](crypto._node_crypto_.Hmac.md#cancel)
- [close](crypto._node_crypto_.Hmac.md#close)
- [cork](crypto._node_crypto_.Hmac.md#cork)
- [destroy](crypto._node_crypto_.Hmac.md#destroy)
- [digest](crypto._node_crypto_.Hmac.md#digest)
- [emit](crypto._node_crypto_.Hmac.md#emit)
- [end](crypto._node_crypto_.Hmac.md#end)
- [eventNames](crypto._node_crypto_.Hmac.md#eventnames)
- [forEach](crypto._node_crypto_.Hmac.md#foreach)
- [getMaxListeners](crypto._node_crypto_.Hmac.md#getmaxlisteners)
- [getReader](crypto._node_crypto_.Hmac.md#getreader)
- [getWriter](crypto._node_crypto_.Hmac.md#getwriter)
- [isPaused](crypto._node_crypto_.Hmac.md#ispaused)
- [listenerCount](crypto._node_crypto_.Hmac.md#listenercount)
- [listeners](crypto._node_crypto_.Hmac.md#listeners)
- [off](crypto._node_crypto_.Hmac.md#off)
- [on](crypto._node_crypto_.Hmac.md#on)
- [once](crypto._node_crypto_.Hmac.md#once)
- [pause](crypto._node_crypto_.Hmac.md#pause)
- [pipe](crypto._node_crypto_.Hmac.md#pipe)
- [pipeThrough](crypto._node_crypto_.Hmac.md#pipethrough)
- [pipeTo](crypto._node_crypto_.Hmac.md#pipeto)
- [prependListener](crypto._node_crypto_.Hmac.md#prependlistener)
- [prependOnceListener](crypto._node_crypto_.Hmac.md#prependoncelistener)
- [push](crypto._node_crypto_.Hmac.md#push)
- [rawListeners](crypto._node_crypto_.Hmac.md#rawlisteners)
- [read](crypto._node_crypto_.Hmac.md#read)
- [removeAllListeners](crypto._node_crypto_.Hmac.md#removealllisteners)
- [removeListener](crypto._node_crypto_.Hmac.md#removelistener)
- [resume](crypto._node_crypto_.Hmac.md#resume)
- [setDefaultEncoding](crypto._node_crypto_.Hmac.md#setdefaultencoding)
- [setEncoding](crypto._node_crypto_.Hmac.md#setencoding)
- [setMaxListeners](crypto._node_crypto_.Hmac.md#setmaxlisteners)
- [tee](crypto._node_crypto_.Hmac.md#tee)
- [uncork](crypto._node_crypto_.Hmac.md#uncork)
- [unpipe](crypto._node_crypto_.Hmac.md#unpipe)
- [unshift](crypto._node_crypto_.Hmac.md#unshift)
- [update](crypto._node_crypto_.Hmac.md#update)
- [wrap](crypto._node_crypto_.Hmac.md#wrap)
- [write](crypto._node_crypto_.Hmac.md#write)
- [from](crypto._node_crypto_.Hmac.md#from)
- [getEventListeners](crypto._node_crypto_.Hmac.md#geteventlisteners)
- [isDisturbed](crypto._node_crypto_.Hmac.md#isdisturbed)
- [listenerCount](crypto._node_crypto_.Hmac.md#listenercount-1)
- [on](crypto._node_crypto_.Hmac.md#on-1)
- [once](crypto._node_crypto_.Hmac.md#once-1)
- [setMaxListeners](crypto._node_crypto_.Hmac.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](crypto._node_crypto_.Hmac.md#uncork) or [end](crypto._node_crypto_.Hmac.md#end) methods are called.
...
Calling the [write](crypto._node_crypto_.Hmac.md#write) method after calling [end](crypto._node_crypto_.Hmac.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](crypto._node_crypto_.Hmac.md#defaultmaxlisteners).
...
Calling [read](crypto._node_crypto_.Hmac.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._node_crypto_.Hmac.md#cork) was called.
...
using the [pipe](crypto._node_crypto_.Hmac.md#pipe) method.
...
Unlike [push](crypto._node_crypto_.Hmac.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto._node_crypto_.Hmac.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto._node_crypto_.Hmac.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto._node_crypto_.Hmac.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._node_crypto_.Hmac.md#pipe). However, if calling `write()` is preferred, it is
