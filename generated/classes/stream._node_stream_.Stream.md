...
[stream](../modules/stream.md).["node:stream"](../modules/stream._node_stream_.md).Stream
...
- [constructor](stream._node_stream_.Stream.md#constructor)

### Properties

- [captureRejectionSymbol](stream._node_stream_.Stream.md#capturerejectionsymbol)
- [captureRejections](stream._node_stream_.Stream.md#capturerejections)
- [defaultMaxListeners](stream._node_stream_.Stream.md#defaultmaxlisteners)
- [errorMonitor](stream._node_stream_.Stream.md#errormonitor)

### Methods

- [addListener](stream._node_stream_.Stream.md#addlistener)
- [emit](stream._node_stream_.Stream.md#emit)
- [eventNames](stream._node_stream_.Stream.md#eventnames)
- [getMaxListeners](stream._node_stream_.Stream.md#getmaxlisteners)
- [listenerCount](stream._node_stream_.Stream.md#listenercount)
- [listeners](stream._node_stream_.Stream.md#listeners)
- [off](stream._node_stream_.Stream.md#off)
- [on](stream._node_stream_.Stream.md#on)
- [once](stream._node_stream_.Stream.md#once)
- [pipe](stream._node_stream_.Stream.md#pipe)
- [prependListener](stream._node_stream_.Stream.md#prependlistener)
- [prependOnceListener](stream._node_stream_.Stream.md#prependoncelistener)
- [rawListeners](stream._node_stream_.Stream.md#rawlisteners)
- [removeAllListeners](stream._node_stream_.Stream.md#removealllisteners)
- [removeListener](stream._node_stream_.Stream.md#removelistener)
- [setMaxListeners](stream._node_stream_.Stream.md#setmaxlisteners)
- [getEventListeners](stream._node_stream_.Stream.md#geteventlisteners)
- [listenerCount](stream._node_stream_.Stream.md#listenercount-1)
- [on](stream._node_stream_.Stream.md#on-1)
- [once](stream._node_stream_.Stream.md#once-1)
- [setMaxListeners](stream._node_stream_.Stream.md#setmaxlisteners-1)
...
[stream.d.ts:31](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/stream.d.ts#L31)
...
▸ **addListener**(`eventName`, `listener`): [`Stream`](stream._stream_.Stream.md)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](stream._node_stream_.Stream.md#defaultmaxlisteners).
...
▸ **off**(`eventName`, `listener`): [`Stream`](stream._stream_.Stream.md)
...
▸ **on**(`eventName`, `listener`): [`Stream`](stream._stream_.Stream.md)
...
▸ **once**(`eventName`, `listener`): [`Stream`](stream._stream_.Stream.md)
...
▸ **prependListener**(`eventName`, `listener`): [`Stream`](stream._stream_.Stream.md)
...
▸ **prependOnceListener**(`eventName`, `listener`): [`Stream`](stream._stream_.Stream.md)
...
▸ **removeAllListeners**(`event?`): [`Stream`](stream._stream_.Stream.md)
...
▸ **removeListener**(`eventName`, `listener`): [`Stream`](stream._stream_.Stream.md)
...
▸ **setMaxListeners**(`n`): [`Stream`](stream._stream_.Stream.md)
