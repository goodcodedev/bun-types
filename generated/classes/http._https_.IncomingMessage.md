...
[http](../modules/http.md).["https"](../modules/http._https_.md).IncomingMessage

An `IncomingMessage` object is created by Server or [ClientRequest](http._https_.ClientRequest.md) and passed as the first argument to the `'request'` and `'response'` event respectively. It may be used to
access response
...
- [constructor](http._https_.IncomingMessage.md#constructor)

### Properties

- [aborted](http._https_.IncomingMessage.md#aborted)
- [complete](http._https_.IncomingMessage.md#complete)
- [destroyed](http._https_.IncomingMessage.md#destroyed)
- [headers](http._https_.IncomingMessage.md#headers)
- [httpVersion](http._https_.IncomingMessage.md#httpversion)
- [httpVersionMajor](http._https_.IncomingMessage.md#httpversionmajor)
- [httpVersionMinor](http._https_.IncomingMessage.md#httpversionminor)
- [locked](http._https_.IncomingMessage.md#locked)
- [method](http._https_.IncomingMessage.md#method)
- [rawHeaders](http._https_.IncomingMessage.md#rawheaders)
- [rawTrailers](http._https_.IncomingMessage.md#rawtrailers)
- [readable](http._https_.IncomingMessage.md#readable)
- [readableAborted](http._https_.IncomingMessage.md#readableaborted)
- [readableEncoding](http._https_.IncomingMessage.md#readableencoding)
- [readableEnded](http._https_.IncomingMessage.md#readableended)
- [readableFlowing](http._https_.IncomingMessage.md#readableflowing)
- [readableHighWaterMark](http._https_.IncomingMessage.md#readablehighwatermark)
- [readableLength](http._https_.IncomingMessage.md#readablelength)
- [readableObjectMode](http._https_.IncomingMessage.md#readableobjectmode)
- [statusCode](http._https_.IncomingMessage.md#statuscode)
- [statusMessage](http._https_.IncomingMessage.md#statusmessage)
- [trailers](http._https_.IncomingMessage.md#trailers)
- [url](http._https_.IncomingMessage.md#url)
- [captureRejectionSymbol](http._https_.IncomingMessage.md#capturerejectionsymbol)
- [captureRejections](http._https_.IncomingMessage.md#capturerejections)
- [defaultMaxListeners](http._https_.IncomingMessage.md#defaultmaxlisteners)
- [errorMonitor](http._https_.IncomingMessage.md#errormonitor)

### Methods

- [[asyncIterator]](http._https_.IncomingMessage.md#[asynciterator])
- [\_construct](http._https_.IncomingMessage.md#_construct)
- [\_destroy](http._https_.IncomingMessage.md#_destroy)
- [\_read](http._https_.IncomingMessage.md#_read)
- [addListener](http._https_.IncomingMessage.md#addlistener)
- [cancel](http._https_.IncomingMessage.md#cancel)
- [destroy](http._https_.IncomingMessage.md#destroy)
- [emit](http._https_.IncomingMessage.md#emit)
- [eventNames](http._https_.IncomingMessage.md#eventnames)
- [forEach](http._https_.IncomingMessage.md#foreach)
- [getMaxListeners](http._https_.IncomingMessage.md#getmaxlisteners)
- [getReader](http._https_.IncomingMessage.md#getreader)
- [isPaused](http._https_.IncomingMessage.md#ispaused)
- [listenerCount](http._https_.IncomingMessage.md#listenercount)
- [listeners](http._https_.IncomingMessage.md#listeners)
- [off](http._https_.IncomingMessage.md#off)
- [on](http._https_.IncomingMessage.md#on)
- [once](http._https_.IncomingMessage.md#once)
- [pause](http._https_.IncomingMessage.md#pause)
- [pipe](http._https_.IncomingMessage.md#pipe)
- [pipeThrough](http._https_.IncomingMessage.md#pipethrough)
- [pipeTo](http._https_.IncomingMessage.md#pipeto)
- [prependListener](http._https_.IncomingMessage.md#prependlistener)
- [prependOnceListener](http._https_.IncomingMessage.md#prependoncelistener)
- [push](http._https_.IncomingMessage.md#push)
- [rawListeners](http._https_.IncomingMessage.md#rawlisteners)
- [read](http._https_.IncomingMessage.md#read)
- [removeAllListeners](http._https_.IncomingMessage.md#removealllisteners)
- [removeListener](http._https_.IncomingMessage.md#removelistener)
- [resume](http._https_.IncomingMessage.md#resume)
- [setEncoding](http._https_.IncomingMessage.md#setencoding)
- [setMaxListeners](http._https_.IncomingMessage.md#setmaxlisteners)
- [setTimeout](http._https_.IncomingMessage.md#settimeout)
- [tee](http._https_.IncomingMessage.md#tee)
- [unpipe](http._https_.IncomingMessage.md#unpipe)
- [unshift](http._https_.IncomingMessage.md#unshift)
- [wrap](http._https_.IncomingMessage.md#wrap)
- [from](http._https_.IncomingMessage.md#from)
- [getEventListeners](http._https_.IncomingMessage.md#geteventlisteners)
- [isDisturbed](http._https_.IncomingMessage.md#isdisturbed)
- [listenerCount](http._https_.IncomingMessage.md#listenercount-1)
- [on](http._https_.IncomingMessage.md#on-1)
- [once](http._https_.IncomingMessage.md#once-1)
- [setMaxListeners](http._https_.IncomingMessage.md#setmaxlisteners-1)
...
**Only valid for response obtained from [ClientRequest](http._https_.ClientRequest.md).**
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](http._https_.IncomingMessage.md#defaultmaxlisteners).
...
Calling [read](http._https_.IncomingMessage.md#read) after the `'end'` event has
...
using the [pipe](http._https_.IncomingMessage.md#pipe) method.
...
Unlike [push](http._https_.IncomingMessage.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](http._https_.IncomingMessage.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](http._https_.IncomingMessage.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](http._https_.IncomingMessage.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
