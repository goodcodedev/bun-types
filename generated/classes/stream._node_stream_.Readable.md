...
[stream](../modules/stream.md).["node:stream"](../modules/stream._node_stream_.md).Readable
...
- [constructor](stream._node_stream_.Readable.md#constructor)

### Properties

- [destroyed](stream._node_stream_.Readable.md#destroyed)
- [locked](stream._node_stream_.Readable.md#locked)
- [readable](stream._node_stream_.Readable.md#readable)
- [readableAborted](stream._node_stream_.Readable.md#readableaborted)
- [readableEncoding](stream._node_stream_.Readable.md#readableencoding)
- [readableEnded](stream._node_stream_.Readable.md#readableended)
- [readableFlowing](stream._node_stream_.Readable.md#readableflowing)
- [readableHighWaterMark](stream._node_stream_.Readable.md#readablehighwatermark)
- [readableLength](stream._node_stream_.Readable.md#readablelength)
- [readableObjectMode](stream._node_stream_.Readable.md#readableobjectmode)
- [captureRejectionSymbol](stream._node_stream_.Readable.md#capturerejectionsymbol)
- [captureRejections](stream._node_stream_.Readable.md#capturerejections)
- [defaultMaxListeners](stream._node_stream_.Readable.md#defaultmaxlisteners)
- [errorMonitor](stream._node_stream_.Readable.md#errormonitor)

### Methods

- [[asyncIterator]](stream._node_stream_.Readable.md#[asynciterator])
- [\_construct](stream._node_stream_.Readable.md#_construct)
- [\_destroy](stream._node_stream_.Readable.md#_destroy)
- [\_read](stream._node_stream_.Readable.md#_read)
- [addListener](stream._node_stream_.Readable.md#addlistener)
- [cancel](stream._node_stream_.Readable.md#cancel)
- [destroy](stream._node_stream_.Readable.md#destroy)
- [emit](stream._node_stream_.Readable.md#emit)
- [eventNames](stream._node_stream_.Readable.md#eventnames)
- [forEach](stream._node_stream_.Readable.md#foreach)
- [getMaxListeners](stream._node_stream_.Readable.md#getmaxlisteners)
- [getReader](stream._node_stream_.Readable.md#getreader)
- [isPaused](stream._node_stream_.Readable.md#ispaused)
- [listenerCount](stream._node_stream_.Readable.md#listenercount)
- [listeners](stream._node_stream_.Readable.md#listeners)
- [off](stream._node_stream_.Readable.md#off)
- [on](stream._node_stream_.Readable.md#on)
- [once](stream._node_stream_.Readable.md#once)
- [pause](stream._node_stream_.Readable.md#pause)
- [pipe](stream._node_stream_.Readable.md#pipe)
- [pipeThrough](stream._node_stream_.Readable.md#pipethrough)
- [pipeTo](stream._node_stream_.Readable.md#pipeto)
- [prependListener](stream._node_stream_.Readable.md#prependlistener)
- [prependOnceListener](stream._node_stream_.Readable.md#prependoncelistener)
- [push](stream._node_stream_.Readable.md#push)
- [rawListeners](stream._node_stream_.Readable.md#rawlisteners)
- [read](stream._node_stream_.Readable.md#read)
- [removeAllListeners](stream._node_stream_.Readable.md#removealllisteners)
- [removeListener](stream._node_stream_.Readable.md#removelistener)
- [resume](stream._node_stream_.Readable.md#resume)
- [setEncoding](stream._node_stream_.Readable.md#setencoding)
- [setMaxListeners](stream._node_stream_.Readable.md#setmaxlisteners)
- [tee](stream._node_stream_.Readable.md#tee)
- [unpipe](stream._node_stream_.Readable.md#unpipe)
- [unshift](stream._node_stream_.Readable.md#unshift)
- [wrap](stream._node_stream_.Readable.md#wrap)
- [from](stream._node_stream_.Readable.md#from)
- [getEventListeners](stream._node_stream_.Readable.md#geteventlisteners)
- [isDisturbed](stream._node_stream_.Readable.md#isdisturbed)
- [listenerCount](stream._node_stream_.Readable.md#listenercount-1)
- [on](stream._node_stream_.Readable.md#on-1)
- [once](stream._node_stream_.Readable.md#once-1)
- [setMaxListeners](stream._node_stream_.Readable.md#setmaxlisteners-1)
...
▸ **addListener**(`event`, `listener`): [`Readable`](stream._stream_.Readable.md)<`R`\>
...
[`Readable`](stream._stream_.Readable.md)<`R`\>
...
▸ **destroy**(`error?`): [`Readable`](stream._stream_.Readable.md)<`R`\>
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](stream._node_stream_.Readable.md#defaultmaxlisteners).
...
▸ **off**(`eventName`, `listener`): [`Readable`](stream._stream_.Readable.md)<`R`\>
...
▸ **on**(`event`, `listener`): [`Readable`](stream._stream_.Readable.md)<`R`\>
...
▸ **once**(`event`, `listener`): [`Readable`](stream._stream_.Readable.md)<`R`\>
...
▸ **pause**(): [`Readable`](stream._stream_.Readable.md)<`R`\>
...
| Name | Type |
| :------ | :------ |
| `transform` | [`ReadableWritablePair`](../interfaces/globals.ReadableWritablePair.md)<`T`, `R`\> |
...
▸ **prependListener**(`event`, `listener`): [`Readable`](stream._stream_.Readable.md)<`R`\>
...
▸ **prependOnceListener**(`event`, `listener`): [`Readable`](stream._stream_.Readable.md)<`R`\>
...
Calling [read](stream._node_stream_.Readable.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`Readable`](stream._stream_.Readable.md)<`R`\>
...
▸ **removeListener**(`event`, `listener`): [`Readable`](stream._stream_.Readable.md)<`R`\>
...
▸ **resume**(): [`Readable`](stream._stream_.Readable.md)<`R`\>
...
▸ **setEncoding**(`encoding`): [`Readable`](stream._stream_.Readable.md)<`R`\>
...
▸ **setMaxListeners**(`n`): [`Readable`](stream._stream_.Readable.md)<`R`\>
...
▸ **unpipe**(`destination?`): [`Readable`](stream._stream_.Readable.md)<`R`\>

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](stream._node_stream_.Readable.md#pipe) method.
...
Unlike [push](stream._node_stream_.Readable.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](stream._node_stream_.Readable.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](stream._node_stream_.Readable.md#push) will reset the reading state appropriately,
...
▸ **wrap**(`stream`): [`Readable`](stream._stream_.Readable.md)<`R`\>

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](stream._node_stream_.Readable.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
[Stream](stream._stream_.Stream.md).[on](stream._stream_.Stream.md#on-1)
