...
[http](../modules/http.md).["http"](../modules/http._http_.md).IncomingMessage

An `IncomingMessage` object is created by Server or [ClientRequest](http._http_.ClientRequest.md) and passed as the first argument to the `'request'` and `'response'` event respectively. It may be used to
access response
...
- [constructor](http._http_.IncomingMessage.md#constructor)

### Properties

- [aborted](http._http_.IncomingMessage.md#aborted)
- [complete](http._http_.IncomingMessage.md#complete)
- [destroyed](http._http_.IncomingMessage.md#destroyed)
- [headers](http._http_.IncomingMessage.md#headers)
- [httpVersion](http._http_.IncomingMessage.md#httpversion)
- [httpVersionMajor](http._http_.IncomingMessage.md#httpversionmajor)
- [httpVersionMinor](http._http_.IncomingMessage.md#httpversionminor)
- [locked](http._http_.IncomingMessage.md#locked)
- [method](http._http_.IncomingMessage.md#method)
- [rawHeaders](http._http_.IncomingMessage.md#rawheaders)
- [rawTrailers](http._http_.IncomingMessage.md#rawtrailers)
- [readable](http._http_.IncomingMessage.md#readable)
- [readableAborted](http._http_.IncomingMessage.md#readableaborted)
- [readableEncoding](http._http_.IncomingMessage.md#readableencoding)
- [readableEnded](http._http_.IncomingMessage.md#readableended)
- [readableFlowing](http._http_.IncomingMessage.md#readableflowing)
- [readableHighWaterMark](http._http_.IncomingMessage.md#readablehighwatermark)
- [readableLength](http._http_.IncomingMessage.md#readablelength)
- [readableObjectMode](http._http_.IncomingMessage.md#readableobjectmode)
- [statusCode](http._http_.IncomingMessage.md#statuscode)
- [statusMessage](http._http_.IncomingMessage.md#statusmessage)
- [trailers](http._http_.IncomingMessage.md#trailers)
- [url](http._http_.IncomingMessage.md#url)
- [captureRejectionSymbol](http._http_.IncomingMessage.md#capturerejectionsymbol)
- [captureRejections](http._http_.IncomingMessage.md#capturerejections)
- [defaultMaxListeners](http._http_.IncomingMessage.md#defaultmaxlisteners)
- [errorMonitor](http._http_.IncomingMessage.md#errormonitor)

### Methods

- [[asyncIterator]](http._http_.IncomingMessage.md#[asynciterator])
- [\_construct](http._http_.IncomingMessage.md#_construct)
- [\_destroy](http._http_.IncomingMessage.md#_destroy)
- [\_read](http._http_.IncomingMessage.md#_read)
- [addListener](http._http_.IncomingMessage.md#addlistener)
- [cancel](http._http_.IncomingMessage.md#cancel)
- [destroy](http._http_.IncomingMessage.md#destroy)
- [emit](http._http_.IncomingMessage.md#emit)
- [eventNames](http._http_.IncomingMessage.md#eventnames)
- [forEach](http._http_.IncomingMessage.md#foreach)
- [getMaxListeners](http._http_.IncomingMessage.md#getmaxlisteners)
- [getReader](http._http_.IncomingMessage.md#getreader)
- [isPaused](http._http_.IncomingMessage.md#ispaused)
- [listenerCount](http._http_.IncomingMessage.md#listenercount)
- [listeners](http._http_.IncomingMessage.md#listeners)
- [off](http._http_.IncomingMessage.md#off)
- [on](http._http_.IncomingMessage.md#on)
- [once](http._http_.IncomingMessage.md#once)
- [pause](http._http_.IncomingMessage.md#pause)
- [pipe](http._http_.IncomingMessage.md#pipe)
- [pipeThrough](http._http_.IncomingMessage.md#pipethrough)
- [pipeTo](http._http_.IncomingMessage.md#pipeto)
- [prependListener](http._http_.IncomingMessage.md#prependlistener)
- [prependOnceListener](http._http_.IncomingMessage.md#prependoncelistener)
- [push](http._http_.IncomingMessage.md#push)
- [rawListeners](http._http_.IncomingMessage.md#rawlisteners)
- [read](http._http_.IncomingMessage.md#read)
- [removeAllListeners](http._http_.IncomingMessage.md#removealllisteners)
- [removeListener](http._http_.IncomingMessage.md#removelistener)
- [resume](http._http_.IncomingMessage.md#resume)
- [setEncoding](http._http_.IncomingMessage.md#setencoding)
- [setMaxListeners](http._http_.IncomingMessage.md#setmaxlisteners)
- [setTimeout](http._http_.IncomingMessage.md#settimeout)
- [tee](http._http_.IncomingMessage.md#tee)
- [unpipe](http._http_.IncomingMessage.md#unpipe)
- [unshift](http._http_.IncomingMessage.md#unshift)
- [wrap](http._http_.IncomingMessage.md#wrap)
- [from](http._http_.IncomingMessage.md#from)
- [getEventListeners](http._http_.IncomingMessage.md#geteventlisteners)
- [isDisturbed](http._http_.IncomingMessage.md#isdisturbed)
- [listenerCount](http._http_.IncomingMessage.md#listenercount-1)
- [on](http._http_.IncomingMessage.md#on-1)
- [once](http._http_.IncomingMessage.md#once-1)
- [setMaxListeners](http._http_.IncomingMessage.md#setmaxlisteners-1)
...
**Only valid for response obtained from [ClientRequest](http._http_.ClientRequest.md).**
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](http._http_.IncomingMessage.md#defaultmaxlisteners).
...
Calling [read](http._http_.IncomingMessage.md#read) after the `'end'` event has
...
using the [pipe](http._http_.IncomingMessage.md#pipe) method.
...
Unlike [push](http._http_.IncomingMessage.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](http._http_.IncomingMessage.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](http._http_.IncomingMessage.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](http._http_.IncomingMessage.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
