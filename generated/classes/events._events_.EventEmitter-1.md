...
[events](../modules/events.md).["events"](../modules/events._events_.md).EventEmitter
...
- **`EventEmitter`**
  ...
  ↳ [`Domain`](domain._node_domain_.Domain.md)

## Table of contents

### Constructors

- [constructor](events._events_.EventEmitter-1.md#constructor)

### Properties

- [captureRejectionSymbol](events._events_.EventEmitter-1.md#capturerejectionsymbol)
- [captureRejections](events._events_.EventEmitter-1.md#capturerejections)
- [defaultMaxListeners](events._events_.EventEmitter-1.md#defaultmaxlisteners)
- [errorMonitor](events._events_.EventEmitter-1.md#errormonitor)

### Methods

- [addListener](events._events_.EventEmitter-1.md#addlistener)
- [emit](events._events_.EventEmitter-1.md#emit)
- [eventNames](events._events_.EventEmitter-1.md#eventnames)
- [getMaxListeners](events._events_.EventEmitter-1.md#getmaxlisteners)
- [listenerCount](events._events_.EventEmitter-1.md#listenercount)
- [listeners](events._events_.EventEmitter-1.md#listeners)
- [off](events._events_.EventEmitter-1.md#off)
- [on](events._events_.EventEmitter-1.md#on)
- [once](events._events_.EventEmitter-1.md#once)
- [prependListener](events._events_.EventEmitter-1.md#prependlistener)
- [prependOnceListener](events._events_.EventEmitter-1.md#prependoncelistener)
- [rawListeners](events._events_.EventEmitter-1.md#rawlisteners)
- [removeAllListeners](events._events_.EventEmitter-1.md#removealllisteners)
- [removeListener](events._events_.EventEmitter-1.md#removelistener)
- [setMaxListeners](events._events_.EventEmitter-1.md#setmaxlisteners)
- [getEventListeners](events._events_.EventEmitter-1.md#geteventlisteners)
- [listenerCount](events._events_.EventEmitter-1.md#listenercount-1)
- [on](events._events_.EventEmitter-1.md#on-1)
- [once](events._events_.EventEmitter-1.md#once-1)
- [setMaxListeners](events._events_.EventEmitter-1.md#setmaxlisteners-1)
...
▸ **addListener**(`eventName`, `listener`): [`EventEmitter`](events._events_.EventEmitter-1.md)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](events._events_.EventEmitter-1.md#defaultmaxlisteners).
...
▸ **off**(`eventName`, `listener`): [`EventEmitter`](events._events_.EventEmitter-1.md)
...
▸ **on**(`eventName`, `listener`): [`EventEmitter`](events._events_.EventEmitter-1.md)
...
▸ **once**(`eventName`, `listener`): [`EventEmitter`](events._events_.EventEmitter-1.md)
...
▸ **prependListener**(`eventName`, `listener`): [`EventEmitter`](events._events_.EventEmitter-1.md)
...
▸ **prependOnceListener**(`eventName`, `listener`): [`EventEmitter`](events._events_.EventEmitter-1.md)
...
▸ **removeAllListeners**(`event?`): [`EventEmitter`](events._events_.EventEmitter-1.md)
...
▸ **removeListener**(`eventName`, `listener`): [`EventEmitter`](events._events_.EventEmitter-1.md)
...
[events.d.ts:203](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/events.d.ts#L203)

___

### setMaxListeners

▸ **setMaxListeners**(`n`): [`EventEmitter`](events._events_.EventEmitter-1.md)
