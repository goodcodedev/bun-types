...
[stream](../modules/stream.md).["stream"](../modules/stream._stream_.md).Transform
...
- [`Duplex`](stream._stream_.Duplex.md)
  ...
  ↳↳ [`PassThrough`](stream._stream_.PassThrough.md)

  ↳↳ [`PassThrough`](stream._node_stream_.PassThrough.md)

  ↳↳ [`Hash`](crypto._crypto_.Hash.md)

  ↳↳ [`Hmac`](crypto._crypto_.Hmac.md)

  ↳↳ [`Cipher`](crypto._crypto_.Cipher.md)

  ↳↳ [`Decipher`](crypto._crypto_.Decipher.md)

  ↳↳ [`Hash`](crypto._node_crypto_.Hash.md)

  ↳↳ [`Hmac`](crypto._node_crypto_.Hmac.md)

  ↳↳ [`Cipher`](crypto._node_crypto_.Cipher.md)

  ↳↳ [`Decipher`](crypto._node_crypto_.Decipher.md)
...
- [constructor](stream._stream_.Transform.md#constructor)

### Properties

- [allowHalfOpen](stream._stream_.Transform.md#allowhalfopen)
- [destroyed](stream._stream_.Transform.md#destroyed)
- [locked](stream._stream_.Transform.md#locked)
- [readable](stream._stream_.Transform.md#readable)
- [readableAborted](stream._stream_.Transform.md#readableaborted)
- [readableEncoding](stream._stream_.Transform.md#readableencoding)
- [readableEnded](stream._stream_.Transform.md#readableended)
- [readableFlowing](stream._stream_.Transform.md#readableflowing)
- [readableHighWaterMark](stream._stream_.Transform.md#readablehighwatermark)
- [readableLength](stream._stream_.Transform.md#readablelength)
- [readableObjectMode](stream._stream_.Transform.md#readableobjectmode)
- [writable](stream._stream_.Transform.md#writable)
- [writableCorked](stream._stream_.Transform.md#writablecorked)
- [writableEnded](stream._stream_.Transform.md#writableended)
- [writableFinished](stream._stream_.Transform.md#writablefinished)
- [writableHighWaterMark](stream._stream_.Transform.md#writablehighwatermark)
- [writableLength](stream._stream_.Transform.md#writablelength)
- [writableObjectMode](stream._stream_.Transform.md#writableobjectmode)
- [captureRejectionSymbol](stream._stream_.Transform.md#capturerejectionsymbol)
- [captureRejections](stream._stream_.Transform.md#capturerejections)
- [defaultMaxListeners](stream._stream_.Transform.md#defaultmaxlisteners)
- [errorMonitor](stream._stream_.Transform.md#errormonitor)

### Methods

- [[asyncIterator]](stream._stream_.Transform.md#[asynciterator])
- [\_construct](stream._stream_.Transform.md#_construct)
- [\_destroy](stream._stream_.Transform.md#_destroy)
- [\_final](stream._stream_.Transform.md#_final)
- [\_flush](stream._stream_.Transform.md#_flush)
- [\_read](stream._stream_.Transform.md#_read)
- [\_transform](stream._stream_.Transform.md#_transform)
- [\_write](stream._stream_.Transform.md#_write)
- [\_writev](stream._stream_.Transform.md#_writev)
- [abort](stream._stream_.Transform.md#abort)
- [addListener](stream._stream_.Transform.md#addlistener)
- [cancel](stream._stream_.Transform.md#cancel)
- [close](stream._stream_.Transform.md#close)
- [cork](stream._stream_.Transform.md#cork)
- [destroy](stream._stream_.Transform.md#destroy)
- [emit](stream._stream_.Transform.md#emit)
- [end](stream._stream_.Transform.md#end)
- [eventNames](stream._stream_.Transform.md#eventnames)
- [forEach](stream._stream_.Transform.md#foreach)
- [getMaxListeners](stream._stream_.Transform.md#getmaxlisteners)
- [getReader](stream._stream_.Transform.md#getreader)
- [getWriter](stream._stream_.Transform.md#getwriter)
- [isPaused](stream._stream_.Transform.md#ispaused)
- [listenerCount](stream._stream_.Transform.md#listenercount)
- [listeners](stream._stream_.Transform.md#listeners)
- [off](stream._stream_.Transform.md#off)
- [on](stream._stream_.Transform.md#on)
- [once](stream._stream_.Transform.md#once)
- [pause](stream._stream_.Transform.md#pause)
- [pipe](stream._stream_.Transform.md#pipe)
- [pipeThrough](stream._stream_.Transform.md#pipethrough)
- [pipeTo](stream._stream_.Transform.md#pipeto)
- [prependListener](stream._stream_.Transform.md#prependlistener)
- [prependOnceListener](stream._stream_.Transform.md#prependoncelistener)
- [push](stream._stream_.Transform.md#push)
- [rawListeners](stream._stream_.Transform.md#rawlisteners)
- [read](stream._stream_.Transform.md#read)
- [removeAllListeners](stream._stream_.Transform.md#removealllisteners)
- [removeListener](stream._stream_.Transform.md#removelistener)
- [resume](stream._stream_.Transform.md#resume)
- [setDefaultEncoding](stream._stream_.Transform.md#setdefaultencoding)
- [setEncoding](stream._stream_.Transform.md#setencoding)
- [setMaxListeners](stream._stream_.Transform.md#setmaxlisteners)
- [tee](stream._stream_.Transform.md#tee)
- [uncork](stream._stream_.Transform.md#uncork)
- [unpipe](stream._stream_.Transform.md#unpipe)
- [unshift](stream._stream_.Transform.md#unshift)
- [wrap](stream._stream_.Transform.md#wrap)
- [write](stream._stream_.Transform.md#write)
- [from](stream._stream_.Transform.md#from)
- [getEventListeners](stream._stream_.Transform.md#geteventlisteners)
- [isDisturbed](stream._stream_.Transform.md#isdisturbed)
- [listenerCount](stream._stream_.Transform.md#listenercount-1)
- [on](stream._stream_.Transform.md#on-1)
- [once](stream._stream_.Transform.md#once-1)
- [setMaxListeners](stream._stream_.Transform.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](stream._stream_.Transform.md#uncork) or [end](stream._stream_.Transform.md#end) methods are called.
...
Calling the [write](stream._stream_.Transform.md#write) method after calling [end](stream._stream_.Transform.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](stream._stream_.Transform.md#defaultmaxlisteners).
...
Calling [read](stream._stream_.Transform.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](stream._stream_.Transform.md#cork) was called.
...
using the [pipe](stream._stream_.Transform.md#pipe) method.
...
Unlike [push](stream._stream_.Transform.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](stream._stream_.Transform.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](stream._stream_.Transform.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](stream._stream_.Transform.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](stream._stream_.Transform.md#pipe). However, if calling `write()` is preferred, it is
