...
[http](../modules/http.md).["node:http"](../modules/http._node_http_.md).IncomingMessage

An `IncomingMessage` object is created by Server or [ClientRequest](http._node_http_.ClientRequest.md) and passed as the first argument to the `'request'` and `'response'` event respectively. It may be used to
access response
...
- [constructor](http._node_http_.IncomingMessage.md#constructor)

### Properties

- [aborted](http._node_http_.IncomingMessage.md#aborted)
- [complete](http._node_http_.IncomingMessage.md#complete)
- [destroyed](http._node_http_.IncomingMessage.md#destroyed)
- [headers](http._node_http_.IncomingMessage.md#headers)
- [httpVersion](http._node_http_.IncomingMessage.md#httpversion)
- [httpVersionMajor](http._node_http_.IncomingMessage.md#httpversionmajor)
- [httpVersionMinor](http._node_http_.IncomingMessage.md#httpversionminor)
- [locked](http._node_http_.IncomingMessage.md#locked)
- [method](http._node_http_.IncomingMessage.md#method)
- [rawHeaders](http._node_http_.IncomingMessage.md#rawheaders)
- [rawTrailers](http._node_http_.IncomingMessage.md#rawtrailers)
- [readable](http._node_http_.IncomingMessage.md#readable)
- [readableAborted](http._node_http_.IncomingMessage.md#readableaborted)
- [readableEncoding](http._node_http_.IncomingMessage.md#readableencoding)
- [readableEnded](http._node_http_.IncomingMessage.md#readableended)
- [readableFlowing](http._node_http_.IncomingMessage.md#readableflowing)
- [readableHighWaterMark](http._node_http_.IncomingMessage.md#readablehighwatermark)
- [readableLength](http._node_http_.IncomingMessage.md#readablelength)
- [readableObjectMode](http._node_http_.IncomingMessage.md#readableobjectmode)
- [statusCode](http._node_http_.IncomingMessage.md#statuscode)
- [statusMessage](http._node_http_.IncomingMessage.md#statusmessage)
- [trailers](http._node_http_.IncomingMessage.md#trailers)
- [url](http._node_http_.IncomingMessage.md#url)
- [captureRejectionSymbol](http._node_http_.IncomingMessage.md#capturerejectionsymbol)
- [captureRejections](http._node_http_.IncomingMessage.md#capturerejections)
- [defaultMaxListeners](http._node_http_.IncomingMessage.md#defaultmaxlisteners)
- [errorMonitor](http._node_http_.IncomingMessage.md#errormonitor)

### Methods

- [[asyncIterator]](http._node_http_.IncomingMessage.md#[asynciterator])
- [\_construct](http._node_http_.IncomingMessage.md#_construct)
- [\_destroy](http._node_http_.IncomingMessage.md#_destroy)
- [\_read](http._node_http_.IncomingMessage.md#_read)
- [addListener](http._node_http_.IncomingMessage.md#addlistener)
- [cancel](http._node_http_.IncomingMessage.md#cancel)
- [destroy](http._node_http_.IncomingMessage.md#destroy)
- [emit](http._node_http_.IncomingMessage.md#emit)
- [eventNames](http._node_http_.IncomingMessage.md#eventnames)
- [forEach](http._node_http_.IncomingMessage.md#foreach)
- [getMaxListeners](http._node_http_.IncomingMessage.md#getmaxlisteners)
- [getReader](http._node_http_.IncomingMessage.md#getreader)
- [isPaused](http._node_http_.IncomingMessage.md#ispaused)
- [listenerCount](http._node_http_.IncomingMessage.md#listenercount)
- [listeners](http._node_http_.IncomingMessage.md#listeners)
- [off](http._node_http_.IncomingMessage.md#off)
- [on](http._node_http_.IncomingMessage.md#on)
- [once](http._node_http_.IncomingMessage.md#once)
- [pause](http._node_http_.IncomingMessage.md#pause)
- [pipe](http._node_http_.IncomingMessage.md#pipe)
- [pipeThrough](http._node_http_.IncomingMessage.md#pipethrough)
- [pipeTo](http._node_http_.IncomingMessage.md#pipeto)
- [prependListener](http._node_http_.IncomingMessage.md#prependlistener)
- [prependOnceListener](http._node_http_.IncomingMessage.md#prependoncelistener)
- [push](http._node_http_.IncomingMessage.md#push)
- [rawListeners](http._node_http_.IncomingMessage.md#rawlisteners)
- [read](http._node_http_.IncomingMessage.md#read)
- [removeAllListeners](http._node_http_.IncomingMessage.md#removealllisteners)
- [removeListener](http._node_http_.IncomingMessage.md#removelistener)
- [resume](http._node_http_.IncomingMessage.md#resume)
- [setEncoding](http._node_http_.IncomingMessage.md#setencoding)
- [setMaxListeners](http._node_http_.IncomingMessage.md#setmaxlisteners)
- [setTimeout](http._node_http_.IncomingMessage.md#settimeout)
- [tee](http._node_http_.IncomingMessage.md#tee)
- [unpipe](http._node_http_.IncomingMessage.md#unpipe)
- [unshift](http._node_http_.IncomingMessage.md#unshift)
- [wrap](http._node_http_.IncomingMessage.md#wrap)
- [from](http._node_http_.IncomingMessage.md#from)
- [getEventListeners](http._node_http_.IncomingMessage.md#geteventlisteners)
- [isDisturbed](http._node_http_.IncomingMessage.md#isdisturbed)
- [listenerCount](http._node_http_.IncomingMessage.md#listenercount-1)
- [on](http._node_http_.IncomingMessage.md#on-1)
- [once](http._node_http_.IncomingMessage.md#once-1)
- [setMaxListeners](http._node_http_.IncomingMessage.md#setmaxlisteners-1)
...
**Only valid for response obtained from [ClientRequest](http._node_http_.ClientRequest.md).**
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](http._node_http_.IncomingMessage.md#defaultmaxlisteners).
...
Calling [read](http._node_http_.IncomingMessage.md#read) after the `'end'` event has
...
using the [pipe](http._node_http_.IncomingMessage.md#pipe) method.
...
Unlike [push](http._node_http_.IncomingMessage.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](http._node_http_.IncomingMessage.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](http._node_http_.IncomingMessage.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](http._node_http_.IncomingMessage.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
