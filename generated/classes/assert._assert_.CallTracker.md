...
[assert](../modules/assert.md).["assert"](../modules/assert._assert_.md).CallTracker
...
- [constructor](assert._assert_.CallTracker.md#constructor)

### Methods

- [calls](assert._assert_.CallTracker.md#calls)
- [report](assert._assert_.CallTracker.md#report)
- [verify](assert._assert_.CallTracker.md#verify)
