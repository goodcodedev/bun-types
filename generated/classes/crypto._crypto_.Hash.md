...
[crypto](../modules/crypto.md).["crypto"](../modules/crypto._crypto_.md).Hash
...
The [createHash](../modules/crypto._crypto_.md#createhash) method is used to create `Hash` instances. `Hash`objects are not to be created directly using the `new` keyword.
...
- [constructor](crypto._crypto_.Hash.md#constructor)

### Properties

- [allowHalfOpen](crypto._crypto_.Hash.md#allowhalfopen)
- [destroyed](crypto._crypto_.Hash.md#destroyed)
- [locked](crypto._crypto_.Hash.md#locked)
- [readable](crypto._crypto_.Hash.md#readable)
- [readableAborted](crypto._crypto_.Hash.md#readableaborted)
- [readableEncoding](crypto._crypto_.Hash.md#readableencoding)
- [readableEnded](crypto._crypto_.Hash.md#readableended)
- [readableFlowing](crypto._crypto_.Hash.md#readableflowing)
- [readableHighWaterMark](crypto._crypto_.Hash.md#readablehighwatermark)
- [readableLength](crypto._crypto_.Hash.md#readablelength)
- [readableObjectMode](crypto._crypto_.Hash.md#readableobjectmode)
- [writable](crypto._crypto_.Hash.md#writable)
- [writableCorked](crypto._crypto_.Hash.md#writablecorked)
- [writableEnded](crypto._crypto_.Hash.md#writableended)
- [writableFinished](crypto._crypto_.Hash.md#writablefinished)
- [writableHighWaterMark](crypto._crypto_.Hash.md#writablehighwatermark)
- [writableLength](crypto._crypto_.Hash.md#writablelength)
- [writableObjectMode](crypto._crypto_.Hash.md#writableobjectmode)
- [captureRejectionSymbol](crypto._crypto_.Hash.md#capturerejectionsymbol)
- [captureRejections](crypto._crypto_.Hash.md#capturerejections)
- [defaultMaxListeners](crypto._crypto_.Hash.md#defaultmaxlisteners)
- [errorMonitor](crypto._crypto_.Hash.md#errormonitor)

### Methods

- [[asyncIterator]](crypto._crypto_.Hash.md#[asynciterator])
- [\_construct](crypto._crypto_.Hash.md#_construct)
- [\_destroy](crypto._crypto_.Hash.md#_destroy)
- [\_final](crypto._crypto_.Hash.md#_final)
- [\_flush](crypto._crypto_.Hash.md#_flush)
- [\_read](crypto._crypto_.Hash.md#_read)
- [\_transform](crypto._crypto_.Hash.md#_transform)
- [\_write](crypto._crypto_.Hash.md#_write)
- [\_writev](crypto._crypto_.Hash.md#_writev)
- [abort](crypto._crypto_.Hash.md#abort)
- [addListener](crypto._crypto_.Hash.md#addlistener)
- [cancel](crypto._crypto_.Hash.md#cancel)
- [close](crypto._crypto_.Hash.md#close)
- [copy](crypto._crypto_.Hash.md#copy)
- [cork](crypto._crypto_.Hash.md#cork)
- [destroy](crypto._crypto_.Hash.md#destroy)
- [digest](crypto._crypto_.Hash.md#digest)
- [emit](crypto._crypto_.Hash.md#emit)
- [end](crypto._crypto_.Hash.md#end)
- [eventNames](crypto._crypto_.Hash.md#eventnames)
- [forEach](crypto._crypto_.Hash.md#foreach)
- [getMaxListeners](crypto._crypto_.Hash.md#getmaxlisteners)
- [getReader](crypto._crypto_.Hash.md#getreader)
- [getWriter](crypto._crypto_.Hash.md#getwriter)
- [isPaused](crypto._crypto_.Hash.md#ispaused)
- [listenerCount](crypto._crypto_.Hash.md#listenercount)
- [listeners](crypto._crypto_.Hash.md#listeners)
- [off](crypto._crypto_.Hash.md#off)
- [on](crypto._crypto_.Hash.md#on)
- [once](crypto._crypto_.Hash.md#once)
- [pause](crypto._crypto_.Hash.md#pause)
- [pipe](crypto._crypto_.Hash.md#pipe)
- [pipeThrough](crypto._crypto_.Hash.md#pipethrough)
- [pipeTo](crypto._crypto_.Hash.md#pipeto)
- [prependListener](crypto._crypto_.Hash.md#prependlistener)
- [prependOnceListener](crypto._crypto_.Hash.md#prependoncelistener)
- [push](crypto._crypto_.Hash.md#push)
- [rawListeners](crypto._crypto_.Hash.md#rawlisteners)
- [read](crypto._crypto_.Hash.md#read)
- [removeAllListeners](crypto._crypto_.Hash.md#removealllisteners)
- [removeListener](crypto._crypto_.Hash.md#removelistener)
- [resume](crypto._crypto_.Hash.md#resume)
- [setDefaultEncoding](crypto._crypto_.Hash.md#setdefaultencoding)
- [setEncoding](crypto._crypto_.Hash.md#setencoding)
- [setMaxListeners](crypto._crypto_.Hash.md#setmaxlisteners)
- [tee](crypto._crypto_.Hash.md#tee)
- [uncork](crypto._crypto_.Hash.md#uncork)
- [unpipe](crypto._crypto_.Hash.md#unpipe)
- [unshift](crypto._crypto_.Hash.md#unshift)
- [update](crypto._crypto_.Hash.md#update)
- [wrap](crypto._crypto_.Hash.md#wrap)
- [write](crypto._crypto_.Hash.md#write)
- [from](crypto._crypto_.Hash.md#from)
- [getEventListeners](crypto._crypto_.Hash.md#geteventlisteners)
- [isDisturbed](crypto._crypto_.Hash.md#isdisturbed)
- [listenerCount](crypto._crypto_.Hash.md#listenercount-1)
- [on](crypto._crypto_.Hash.md#on-1)
- [once](crypto._crypto_.Hash.md#once-1)
- [setMaxListeners](crypto._crypto_.Hash.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](crypto._crypto_.Hash.md#uncork) or [end](crypto._crypto_.Hash.md#end) methods are called.
...
Calling the [write](crypto._crypto_.Hash.md#write) method after calling [end](crypto._crypto_.Hash.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](crypto._crypto_.Hash.md#defaultmaxlisteners).
...
Calling [read](crypto._crypto_.Hash.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._crypto_.Hash.md#cork) was called.
...
using the [pipe](crypto._crypto_.Hash.md#pipe) method.
...
Unlike [push](crypto._crypto_.Hash.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto._crypto_.Hash.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto._crypto_.Hash.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto._crypto_.Hash.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._crypto_.Hash.md#pipe). However, if calling `write()` is preferred, it is
