...
[crypto](../modules/crypto.md).["crypto"](../modules/crypto._crypto_.md).Decipher
...
- [constructor](crypto._crypto_.Decipher.md#constructor)

### Properties

- [allowHalfOpen](crypto._crypto_.Decipher.md#allowhalfopen)
- [destroyed](crypto._crypto_.Decipher.md#destroyed)
- [locked](crypto._crypto_.Decipher.md#locked)
- [readable](crypto._crypto_.Decipher.md#readable)
- [readableAborted](crypto._crypto_.Decipher.md#readableaborted)
- [readableEncoding](crypto._crypto_.Decipher.md#readableencoding)
- [readableEnded](crypto._crypto_.Decipher.md#readableended)
- [readableFlowing](crypto._crypto_.Decipher.md#readableflowing)
- [readableHighWaterMark](crypto._crypto_.Decipher.md#readablehighwatermark)
- [readableLength](crypto._crypto_.Decipher.md#readablelength)
- [readableObjectMode](crypto._crypto_.Decipher.md#readableobjectmode)
- [writable](crypto._crypto_.Decipher.md#writable)
- [writableCorked](crypto._crypto_.Decipher.md#writablecorked)
- [writableEnded](crypto._crypto_.Decipher.md#writableended)
- [writableFinished](crypto._crypto_.Decipher.md#writablefinished)
- [writableHighWaterMark](crypto._crypto_.Decipher.md#writablehighwatermark)
- [writableLength](crypto._crypto_.Decipher.md#writablelength)
- [writableObjectMode](crypto._crypto_.Decipher.md#writableobjectmode)
- [captureRejectionSymbol](crypto._crypto_.Decipher.md#capturerejectionsymbol)
- [captureRejections](crypto._crypto_.Decipher.md#capturerejections)
- [defaultMaxListeners](crypto._crypto_.Decipher.md#defaultmaxlisteners)
- [errorMonitor](crypto._crypto_.Decipher.md#errormonitor)

### Methods

- [[asyncIterator]](crypto._crypto_.Decipher.md#[asynciterator])
- [\_construct](crypto._crypto_.Decipher.md#_construct)
- [\_destroy](crypto._crypto_.Decipher.md#_destroy)
- [\_final](crypto._crypto_.Decipher.md#_final)
- [\_flush](crypto._crypto_.Decipher.md#_flush)
- [\_read](crypto._crypto_.Decipher.md#_read)
- [\_transform](crypto._crypto_.Decipher.md#_transform)
- [\_write](crypto._crypto_.Decipher.md#_write)
- [\_writev](crypto._crypto_.Decipher.md#_writev)
- [abort](crypto._crypto_.Decipher.md#abort)
- [addListener](crypto._crypto_.Decipher.md#addlistener)
- [cancel](crypto._crypto_.Decipher.md#cancel)
- [close](crypto._crypto_.Decipher.md#close)
- [cork](crypto._crypto_.Decipher.md#cork)
- [destroy](crypto._crypto_.Decipher.md#destroy)
- [emit](crypto._crypto_.Decipher.md#emit)
- [end](crypto._crypto_.Decipher.md#end)
- [eventNames](crypto._crypto_.Decipher.md#eventnames)
- [final](crypto._crypto_.Decipher.md#final)
- [forEach](crypto._crypto_.Decipher.md#foreach)
- [getMaxListeners](crypto._crypto_.Decipher.md#getmaxlisteners)
- [getReader](crypto._crypto_.Decipher.md#getreader)
- [getWriter](crypto._crypto_.Decipher.md#getwriter)
- [isPaused](crypto._crypto_.Decipher.md#ispaused)
- [listenerCount](crypto._crypto_.Decipher.md#listenercount)
- [listeners](crypto._crypto_.Decipher.md#listeners)
- [off](crypto._crypto_.Decipher.md#off)
- [on](crypto._crypto_.Decipher.md#on)
- [once](crypto._crypto_.Decipher.md#once)
- [pause](crypto._crypto_.Decipher.md#pause)
- [pipe](crypto._crypto_.Decipher.md#pipe)
- [pipeThrough](crypto._crypto_.Decipher.md#pipethrough)
- [pipeTo](crypto._crypto_.Decipher.md#pipeto)
- [prependListener](crypto._crypto_.Decipher.md#prependlistener)
- [prependOnceListener](crypto._crypto_.Decipher.md#prependoncelistener)
- [push](crypto._crypto_.Decipher.md#push)
- [rawListeners](crypto._crypto_.Decipher.md#rawlisteners)
- [read](crypto._crypto_.Decipher.md#read)
- [removeAllListeners](crypto._crypto_.Decipher.md#removealllisteners)
- [removeListener](crypto._crypto_.Decipher.md#removelistener)
- [resume](crypto._crypto_.Decipher.md#resume)
- [setAutoPadding](crypto._crypto_.Decipher.md#setautopadding)
- [setDefaultEncoding](crypto._crypto_.Decipher.md#setdefaultencoding)
- [setEncoding](crypto._crypto_.Decipher.md#setencoding)
- [setMaxListeners](crypto._crypto_.Decipher.md#setmaxlisteners)
- [tee](crypto._crypto_.Decipher.md#tee)
- [uncork](crypto._crypto_.Decipher.md#uncork)
- [unpipe](crypto._crypto_.Decipher.md#unpipe)
- [unshift](crypto._crypto_.Decipher.md#unshift)
- [update](crypto._crypto_.Decipher.md#update)
- [wrap](crypto._crypto_.Decipher.md#wrap)
- [write](crypto._crypto_.Decipher.md#write)
- [from](crypto._crypto_.Decipher.md#from)
- [getEventListeners](crypto._crypto_.Decipher.md#geteventlisteners)
- [isDisturbed](crypto._crypto_.Decipher.md#isdisturbed)
- [listenerCount](crypto._crypto_.Decipher.md#listenercount-1)
- [on](crypto._crypto_.Decipher.md#on-1)
- [once](crypto._crypto_.Decipher.md#once-1)
- [setMaxListeners](crypto._crypto_.Decipher.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](crypto._crypto_.Decipher.md#uncork) or [end](crypto._crypto_.Decipher.md#end) methods are called.
...
Calling the [write](crypto._crypto_.Decipher.md#write) method after calling [end](crypto._crypto_.Decipher.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](crypto._crypto_.Decipher.md#defaultmaxlisteners).
...
Calling [read](crypto._crypto_.Decipher.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._crypto_.Decipher.md#cork) was called.
...
using the [pipe](crypto._crypto_.Decipher.md#pipe) method.
...
Unlike [push](crypto._crypto_.Decipher.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto._crypto_.Decipher.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto._crypto_.Decipher.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](crypto._crypto_.Decipher.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._crypto_.Decipher.md#pipe). However, if calling `write()` is preferred, it is
