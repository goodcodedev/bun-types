...
[bun](../modules/bun.md).["bun"](../modules/bun._bun_.md).MD5

This class only exists in types

## Hierarchy

- [`CryptoHashInterface`](bun._bun_.CryptoHashInterface.md)<[`MD5`](bun._bun_.MD5.md)\>
...
- [constructor](bun._bun_.MD5.md#constructor)

### Properties

- [byteLength](bun._bun_.MD5.md#bytelength)

### Methods

- [digest](bun._bun_.MD5.md#digest)
- [update](bun._bun_.MD5.md#update)
- [hash](bun._bun_.MD5.md#hash)
...
[bun.d.ts:1143](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/bun.d.ts#L1143)
...
[bun.d.ts:1148](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/bun.d.ts#L1148)
...
▸ **update**(`data`): [`MD5`](bun._bun_.MD5.md)
