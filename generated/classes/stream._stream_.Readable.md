...
[stream](../modules/stream.md).["stream"](../modules/stream._stream_.md).Readable
...
- [`Stream`](stream._stream_.Stream.md)
  ...
  ↳↳ [`IncomingMessage`](http._node_http_.IncomingMessage.md)

  ↳↳ [`IncomingMessage`](http._https_.IncomingMessage.md)

  ↳↳ [`IncomingMessage`](http._node_https_.IncomingMessage.md)
...
- [constructor](stream._stream_.Readable.md#constructor)

### Properties

- [destroyed](stream._stream_.Readable.md#destroyed)
- [locked](stream._stream_.Readable.md#locked)
- [readable](stream._stream_.Readable.md#readable)
- [readableAborted](stream._stream_.Readable.md#readableaborted)
- [readableEncoding](stream._stream_.Readable.md#readableencoding)
- [readableEnded](stream._stream_.Readable.md#readableended)
- [readableFlowing](stream._stream_.Readable.md#readableflowing)
- [readableHighWaterMark](stream._stream_.Readable.md#readablehighwatermark)
- [readableLength](stream._stream_.Readable.md#readablelength)
- [readableObjectMode](stream._stream_.Readable.md#readableobjectmode)
- [captureRejectionSymbol](stream._stream_.Readable.md#capturerejectionsymbol)
- [captureRejections](stream._stream_.Readable.md#capturerejections)
- [defaultMaxListeners](stream._stream_.Readable.md#defaultmaxlisteners)
- [errorMonitor](stream._stream_.Readable.md#errormonitor)

### Methods

- [[asyncIterator]](stream._stream_.Readable.md#[asynciterator])
- [\_construct](stream._stream_.Readable.md#_construct)
- [\_destroy](stream._stream_.Readable.md#_destroy)
- [\_read](stream._stream_.Readable.md#_read)
- [addListener](stream._stream_.Readable.md#addlistener)
- [cancel](stream._stream_.Readable.md#cancel)
- [destroy](stream._stream_.Readable.md#destroy)
- [emit](stream._stream_.Readable.md#emit)
- [eventNames](stream._stream_.Readable.md#eventnames)
- [forEach](stream._stream_.Readable.md#foreach)
- [getMaxListeners](stream._stream_.Readable.md#getmaxlisteners)
- [getReader](stream._stream_.Readable.md#getreader)
- [isPaused](stream._stream_.Readable.md#ispaused)
- [listenerCount](stream._stream_.Readable.md#listenercount)
- [listeners](stream._stream_.Readable.md#listeners)
- [off](stream._stream_.Readable.md#off)
- [on](stream._stream_.Readable.md#on)
- [once](stream._stream_.Readable.md#once)
- [pause](stream._stream_.Readable.md#pause)
- [pipe](stream._stream_.Readable.md#pipe)
- [pipeThrough](stream._stream_.Readable.md#pipethrough)
- [pipeTo](stream._stream_.Readable.md#pipeto)
- [prependListener](stream._stream_.Readable.md#prependlistener)
- [prependOnceListener](stream._stream_.Readable.md#prependoncelistener)
- [push](stream._stream_.Readable.md#push)
- [rawListeners](stream._stream_.Readable.md#rawlisteners)
- [read](stream._stream_.Readable.md#read)
- [removeAllListeners](stream._stream_.Readable.md#removealllisteners)
- [removeListener](stream._stream_.Readable.md#removelistener)
- [resume](stream._stream_.Readable.md#resume)
- [setEncoding](stream._stream_.Readable.md#setencoding)
- [setMaxListeners](stream._stream_.Readable.md#setmaxlisteners)
- [tee](stream._stream_.Readable.md#tee)
- [unpipe](stream._stream_.Readable.md#unpipe)
- [unshift](stream._stream_.Readable.md#unshift)
- [wrap](stream._stream_.Readable.md#wrap)
- [from](stream._stream_.Readable.md#from)
- [getEventListeners](stream._stream_.Readable.md#geteventlisteners)
- [isDisturbed](stream._stream_.Readable.md#isdisturbed)
- [listenerCount](stream._stream_.Readable.md#listenercount-1)
- [on](stream._stream_.Readable.md#on-1)
- [once](stream._stream_.Readable.md#once-1)
- [setMaxListeners](stream._stream_.Readable.md#setmaxlisteners-1)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](stream._stream_.Readable.md#defaultmaxlisteners).
...
Calling [read](stream._stream_.Readable.md#read) after the `'end'` event has
...
using the [pipe](stream._stream_.Readable.md#pipe) method.
...
Unlike [push](stream._stream_.Readable.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](stream._stream_.Readable.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](stream._stream_.Readable.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](stream._stream_.Readable.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
