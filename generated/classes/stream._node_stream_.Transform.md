...
[stream](../modules/stream.md).["node:stream"](../modules/stream._node_stream_.md).Transform
...
- [constructor](stream._node_stream_.Transform.md#constructor)

### Properties

- [allowHalfOpen](stream._node_stream_.Transform.md#allowhalfopen)
- [destroyed](stream._node_stream_.Transform.md#destroyed)
- [locked](stream._node_stream_.Transform.md#locked)
- [readable](stream._node_stream_.Transform.md#readable)
- [readableAborted](stream._node_stream_.Transform.md#readableaborted)
- [readableEncoding](stream._node_stream_.Transform.md#readableencoding)
- [readableEnded](stream._node_stream_.Transform.md#readableended)
- [readableFlowing](stream._node_stream_.Transform.md#readableflowing)
- [readableHighWaterMark](stream._node_stream_.Transform.md#readablehighwatermark)
- [readableLength](stream._node_stream_.Transform.md#readablelength)
- [readableObjectMode](stream._node_stream_.Transform.md#readableobjectmode)
- [writable](stream._node_stream_.Transform.md#writable)
- [writableCorked](stream._node_stream_.Transform.md#writablecorked)
- [writableEnded](stream._node_stream_.Transform.md#writableended)
- [writableFinished](stream._node_stream_.Transform.md#writablefinished)
- [writableHighWaterMark](stream._node_stream_.Transform.md#writablehighwatermark)
- [writableLength](stream._node_stream_.Transform.md#writablelength)
- [writableObjectMode](stream._node_stream_.Transform.md#writableobjectmode)
- [captureRejectionSymbol](stream._node_stream_.Transform.md#capturerejectionsymbol)
- [captureRejections](stream._node_stream_.Transform.md#capturerejections)
- [defaultMaxListeners](stream._node_stream_.Transform.md#defaultmaxlisteners)
- [errorMonitor](stream._node_stream_.Transform.md#errormonitor)

### Methods

- [[asyncIterator]](stream._node_stream_.Transform.md#[asynciterator])
- [\_construct](stream._node_stream_.Transform.md#_construct)
- [\_destroy](stream._node_stream_.Transform.md#_destroy)
- [\_final](stream._node_stream_.Transform.md#_final)
- [\_flush](stream._node_stream_.Transform.md#_flush)
- [\_read](stream._node_stream_.Transform.md#_read)
- [\_transform](stream._node_stream_.Transform.md#_transform)
- [\_write](stream._node_stream_.Transform.md#_write)
- [\_writev](stream._node_stream_.Transform.md#_writev)
- [abort](stream._node_stream_.Transform.md#abort)
- [addListener](stream._node_stream_.Transform.md#addlistener)
- [cancel](stream._node_stream_.Transform.md#cancel)
- [close](stream._node_stream_.Transform.md#close)
- [cork](stream._node_stream_.Transform.md#cork)
- [destroy](stream._node_stream_.Transform.md#destroy)
- [emit](stream._node_stream_.Transform.md#emit)
- [end](stream._node_stream_.Transform.md#end)
- [eventNames](stream._node_stream_.Transform.md#eventnames)
- [forEach](stream._node_stream_.Transform.md#foreach)
- [getMaxListeners](stream._node_stream_.Transform.md#getmaxlisteners)
- [getReader](stream._node_stream_.Transform.md#getreader)
- [getWriter](stream._node_stream_.Transform.md#getwriter)
- [isPaused](stream._node_stream_.Transform.md#ispaused)
- [listenerCount](stream._node_stream_.Transform.md#listenercount)
- [listeners](stream._node_stream_.Transform.md#listeners)
- [off](stream._node_stream_.Transform.md#off)
- [on](stream._node_stream_.Transform.md#on)
- [once](stream._node_stream_.Transform.md#once)
- [pause](stream._node_stream_.Transform.md#pause)
- [pipe](stream._node_stream_.Transform.md#pipe)
- [pipeThrough](stream._node_stream_.Transform.md#pipethrough)
- [pipeTo](stream._node_stream_.Transform.md#pipeto)
- [prependListener](stream._node_stream_.Transform.md#prependlistener)
- [prependOnceListener](stream._node_stream_.Transform.md#prependoncelistener)
- [push](stream._node_stream_.Transform.md#push)
- [rawListeners](stream._node_stream_.Transform.md#rawlisteners)
- [read](stream._node_stream_.Transform.md#read)
- [removeAllListeners](stream._node_stream_.Transform.md#removealllisteners)
- [removeListener](stream._node_stream_.Transform.md#removelistener)
- [resume](stream._node_stream_.Transform.md#resume)
- [setDefaultEncoding](stream._node_stream_.Transform.md#setdefaultencoding)
- [setEncoding](stream._node_stream_.Transform.md#setencoding)
- [setMaxListeners](stream._node_stream_.Transform.md#setmaxlisteners)
- [tee](stream._node_stream_.Transform.md#tee)
- [uncork](stream._node_stream_.Transform.md#uncork)
- [unpipe](stream._node_stream_.Transform.md#unpipe)
- [unshift](stream._node_stream_.Transform.md#unshift)
- [wrap](stream._node_stream_.Transform.md#wrap)
- [write](stream._node_stream_.Transform.md#write)
- [from](stream._node_stream_.Transform.md#from)
- [getEventListeners](stream._node_stream_.Transform.md#geteventlisteners)
- [isDisturbed](stream._node_stream_.Transform.md#isdisturbed)
- [listenerCount](stream._node_stream_.Transform.md#listenercount-1)
- [on](stream._node_stream_.Transform.md#on-1)
- [once](stream._node_stream_.Transform.md#once-1)
- [setMaxListeners](stream._node_stream_.Transform.md#setmaxlisteners-1)
...
| Name | Type |
| :------ | :------ |
| `opts?` | [`TransformOptions`](../interfaces/stream._stream_.TransformOptions.md) |

#### Overrides

[Duplex](stream._stream_.Duplex.md).[constructor](stream._stream_.Duplex.md#constructor)

#### Defined in

[stream.d.ts:981](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/stream.d.ts#L981)
...
[Duplex](stream._stream_.Duplex.md).[allowHalfOpen](stream._stream_.Duplex.md#allowhalfopen)
...
[Duplex](stream._stream_.Duplex.md).[destroyed](stream._stream_.Duplex.md#destroyed)
...
[Duplex](stream._stream_.Duplex.md).[locked](stream._stream_.Duplex.md#locked)
...
[Duplex](stream._stream_.Duplex.md).[readable](stream._stream_.Duplex.md#readable)
...
[Duplex](stream._stream_.Duplex.md).[readableAborted](stream._stream_.Duplex.md#readableaborted)
...
[Duplex](stream._stream_.Duplex.md).[readableEncoding](stream._stream_.Duplex.md#readableencoding)
...
[Duplex](stream._stream_.Duplex.md).[readableEnded](stream._stream_.Duplex.md#readableended)
...
[Duplex](stream._stream_.Duplex.md).[readableFlowing](stream._stream_.Duplex.md#readableflowing)
...
[Duplex](stream._stream_.Duplex.md).[readableHighWaterMark](stream._stream_.Duplex.md#readablehighwatermark)
...
[Duplex](stream._stream_.Duplex.md).[readableLength](stream._stream_.Duplex.md#readablelength)
...
[Duplex](stream._stream_.Duplex.md).[readableObjectMode](stream._stream_.Duplex.md#readableobjectmode)
...
[Duplex](stream._stream_.Duplex.md).[writable](stream._stream_.Duplex.md#writable)
...
[Duplex](stream._stream_.Duplex.md).[writableCorked](stream._stream_.Duplex.md#writablecorked)
...
[Duplex](stream._stream_.Duplex.md).[writableEnded](stream._stream_.Duplex.md#writableended)
...
[Duplex](stream._stream_.Duplex.md).[writableFinished](stream._stream_.Duplex.md#writablefinished)
...
[Duplex](stream._stream_.Duplex.md).[writableHighWaterMark](stream._stream_.Duplex.md#writablehighwatermark)
...
[Duplex](stream._stream_.Duplex.md).[writableLength](stream._stream_.Duplex.md#writablelength)
...
[Duplex](stream._stream_.Duplex.md).[writableObjectMode](stream._stream_.Duplex.md#writableobjectmode)
...
[Duplex](stream._stream_.Duplex.md).[captureRejectionSymbol](stream._stream_.Duplex.md#capturerejectionsymbol)
...
[Duplex](stream._stream_.Duplex.md).[captureRejections](stream._stream_.Duplex.md#capturerejections)
...
[Duplex](stream._stream_.Duplex.md).[defaultMaxListeners](stream._stream_.Duplex.md#defaultmaxlisteners)
...
[Duplex](stream._stream_.Duplex.md).[errorMonitor](stream._stream_.Duplex.md#errormonitor)
...
[Duplex](stream._stream_.Duplex.md).[[asyncIterator]](stream._stream_.Duplex.md#[asynciterator])
...
[Duplex](stream._stream_.Duplex.md).[_construct](stream._stream_.Duplex.md#_construct)
...
[Duplex](stream._stream_.Duplex.md).[_destroy](stream._stream_.Duplex.md#_destroy)
...
[Duplex](stream._stream_.Duplex.md).[_final](stream._stream_.Duplex.md#_final)
...
[Duplex](stream._stream_.Duplex.md).[_read](stream._stream_.Duplex.md#_read)
...
[Duplex](stream._stream_.Duplex.md).[_write](stream._stream_.Duplex.md#_write)
...
[Duplex](stream._stream_.Duplex.md).[_writev](stream._stream_.Duplex.md#_writev)
...
[Duplex](stream._stream_.Duplex.md).[abort](stream._stream_.Duplex.md#abort)
...
▸ **addListener**(`event`, `listener`): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[addListener](stream._stream_.Duplex.md#addlistener)
...
[Duplex](stream._stream_.Duplex.md).[cancel](stream._stream_.Duplex.md#cancel)
...
[Duplex](stream._stream_.Duplex.md).[close](stream._stream_.Duplex.md#close)
...
The buffered data will be flushed when either the [uncork](stream._node_stream_.Transform.md#uncork) or [end](stream._node_stream_.Transform.md#end) methods are called.
...
[Duplex](stream._stream_.Duplex.md).[cork](stream._stream_.Duplex.md#cork)
...
▸ **destroy**(`error?`): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[destroy](stream._stream_.Duplex.md#destroy)
...
[Duplex](stream._stream_.Duplex.md).[emit](stream._stream_.Duplex.md#emit)
...
▸ **end**(`cb?`): [`Transform`](stream._stream_.Transform.md)
...
Calling the [write](stream._node_stream_.Transform.md#write) method after calling [end](stream._node_stream_.Transform.md#end) will raise an error.
...
[Duplex](stream._stream_.Duplex.md).[end](stream._stream_.Duplex.md#end)

#### Defined in

[stream.d.ts:928](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/stream.d.ts#L928)

▸ **end**(`chunk`, `cb?`): [`Transform`](stream._stream_.Transform.md)
...
▸ **end**(`chunk`, `encoding?`, `cb?`): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[eventNames](stream._stream_.Duplex.md#eventnames)
...
[Duplex](stream._stream_.Duplex.md).[forEach](stream._stream_.Duplex.md#foreach)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](stream._node_stream_.Transform.md#defaultmaxlisteners).
...
[Duplex](stream._stream_.Duplex.md).[getMaxListeners](stream._stream_.Duplex.md#getmaxlisteners)
...
[Duplex](stream._stream_.Duplex.md).[getReader](stream._stream_.Duplex.md#getreader)
...
[Duplex](stream._stream_.Duplex.md).[getWriter](stream._stream_.Duplex.md#getwriter)
...
[Duplex](stream._stream_.Duplex.md).[isPaused](stream._stream_.Duplex.md#ispaused)
...
[Duplex](stream._stream_.Duplex.md).[listenerCount](stream._stream_.Duplex.md#listenercount)
...
[Duplex](stream._stream_.Duplex.md).[listeners](stream._stream_.Duplex.md#listeners)
...
▸ **off**(`eventName`, `listener`): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[off](stream._stream_.Duplex.md#off)
...
▸ **on**(`event`, `listener`): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[on](stream._stream_.Duplex.md#on)
...
▸ **once**(`event`, `listener`): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[once](stream._stream_.Duplex.md#once)
...
▸ **pause**(): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[pause](stream._stream_.Duplex.md#pause)
...
[Duplex](stream._stream_.Duplex.md).[pipe](stream._stream_.Duplex.md#pipe)
...
[Duplex](stream._stream_.Duplex.md).[pipeThrough](stream._stream_.Duplex.md#pipethrough)
...
[Duplex](stream._stream_.Duplex.md).[pipeTo](stream._stream_.Duplex.md#pipeto)
...
▸ **prependListener**(`event`, `listener`): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[prependListener](stream._stream_.Duplex.md#prependlistener)
...
▸ **prependOnceListener**(`event`, `listener`): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[prependOnceListener](stream._stream_.Duplex.md#prependoncelistener)
...
[Duplex](stream._stream_.Duplex.md).[push](stream._stream_.Duplex.md#push)
...
[Duplex](stream._stream_.Duplex.md).[rawListeners](stream._stream_.Duplex.md#rawlisteners)
...
Calling [read](stream._node_stream_.Transform.md#read) after the `'end'` event has
...
[Duplex](stream._stream_.Duplex.md).[read](stream._stream_.Duplex.md#read)
...
▸ **removeAllListeners**(`event?`): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[removeAllListeners](stream._stream_.Duplex.md#removealllisteners)
...
▸ **removeListener**(`event`, `listener`): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[removeListener](stream._stream_.Duplex.md#removelistener)
...
▸ **resume**(): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[resume](stream._stream_.Duplex.md#resume)
...
▸ **setDefaultEncoding**(`encoding`): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[setDefaultEncoding](stream._stream_.Duplex.md#setdefaultencoding)
...
▸ **setEncoding**(`encoding`): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[setEncoding](stream._stream_.Duplex.md#setencoding)
...
▸ **setMaxListeners**(`n`): [`Transform`](stream._stream_.Transform.md)
...
[Duplex](stream._stream_.Duplex.md).[setMaxListeners](stream._stream_.Duplex.md#setmaxlisteners)
...
[Duplex](stream._stream_.Duplex.md).[tee](stream._stream_.Duplex.md#tee)
...
The `writable.uncork()` method flushes all data buffered since [cork](stream._node_stream_.Transform.md#cork) was called.
...
[Duplex](stream._stream_.Duplex.md).[uncork](stream._stream_.Duplex.md#uncork)
...
▸ **unpipe**(`destination?`): [`Transform`](stream._stream_.Transform.md)

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](stream._node_stream_.Transform.md#pipe) method.
...
[Duplex](stream._stream_.Duplex.md).[unpipe](stream._stream_.Duplex.md#unpipe)
...
Unlike [push](stream._node_stream_.Transform.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](stream._node_stream_.Transform.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](stream._node_stream_.Transform.md#push) will reset the reading state appropriately,
...
[Duplex](stream._stream_.Duplex.md).[unshift](stream._stream_.Duplex.md#unshift)
...
▸ **wrap**(`stream`): [`Transform`](stream._stream_.Transform.md)

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](stream._node_stream_.Transform.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
[Duplex](stream._stream_.Duplex.md).[wrap](stream._stream_.Duplex.md#wrap)
...
recommended to encapsulate the logic into a `Readable` and use [pipe](stream._node_stream_.Transform.md#pipe). However, if calling `write()` is preferred, it is
...
[Duplex](stream._stream_.Duplex.md).[write](stream._stream_.Duplex.md#write)
...
[Duplex](stream._stream_.Duplex.md).[from](stream._stream_.Duplex.md#from)
...
[Duplex](stream._stream_.Duplex.md).[getEventListeners](stream._stream_.Duplex.md#geteventlisteners)
...
[Duplex](stream._stream_.Duplex.md).[isDisturbed](stream._stream_.Duplex.md#isdisturbed)
...
[Duplex](stream._stream_.Duplex.md).[listenerCount](stream._stream_.Duplex.md#listenercount-1)
...
[Duplex](stream._stream_.Duplex.md).[on](stream._stream_.Duplex.md#on-1)
...
[Duplex](stream._stream_.Duplex.md).[once](stream._stream_.Duplex.md#once-1)
...
[Duplex](stream._stream_.Duplex.md).[setMaxListeners](stream._stream_.Duplex.md#setmaxlisteners-1)
