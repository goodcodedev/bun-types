...
[http](../modules/http.md).["node:http"](../modules/http._node_http_.md).ClientRequest

This object is created internally and returned from [request](../modules/http._node_http_.md#request). It
...
argument which is an instance of [IncomingMessage](http._node_http_.IncomingMessage.md).
...
- [constructor](http._node_http_.ClientRequest.md#constructor)

### Properties

- [aborted](http._node_http_.ClientRequest.md#aborted)
- [host](http._node_http_.ClientRequest.md#host)
- [maxHeadersCount](http._node_http_.ClientRequest.md#maxheaderscount)
- [method](http._node_http_.ClientRequest.md#method)
- [path](http._node_http_.ClientRequest.md#path)
- [protocol](http._node_http_.ClientRequest.md#protocol)
- [reusedSocket](http._node_http_.ClientRequest.md#reusedsocket)

### Methods

- [abort](http._node_http_.ClientRequest.md#abort)
- [addListener](http._node_http_.ClientRequest.md#addlistener)
- [flushHeaders](http._node_http_.ClientRequest.md#flushheaders)
- [getHeader](http._node_http_.ClientRequest.md#getheader)
- [getRawHeaderNames](http._node_http_.ClientRequest.md#getrawheadernames)
- [on](http._node_http_.ClientRequest.md#on)
- [once](http._node_http_.ClientRequest.md#once)
- [prependListener](http._node_http_.ClientRequest.md#prependlistener)
- [prependOnceListener](http._node_http_.ClientRequest.md#prependoncelistener)
- [removeHeader](http._node_http_.ClientRequest.md#removeheader)
- [setHeader](http._node_http_.ClientRequest.md#setheader)
- [setNoDelay](http._node_http_.ClientRequest.md#setnodelay)
- [setSocketKeepAlive](http._node_http_.ClientRequest.md#setsocketkeepalive)
- [setTimeout](http._node_http_.ClientRequest.md#settimeout)
...
[http.d.ts:361](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L361)
...
[http.d.ts:379](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L379)
...
[http.d.ts:397](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L397)
...
[http.d.ts:418](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L418)
