...
[bun](../modules/bun.md).["bun"](../modules/bun._bun_.md).SHA1

This is not the default because it's not cryptographically secure and it's slower than [SHA512](bun._bun_.SHA512.md)

Consider using the ugly-named [SHA512_256](bun._bun_.SHA512_256.md) instead

## Hierarchy

- [`CryptoHashInterface`](bun._bun_.CryptoHashInterface.md)<[`SHA1`](bun._bun_.SHA1.md)\>
...
- [constructor](bun._bun_.SHA1.md#constructor)

### Properties

- [byteLength](bun._bun_.SHA1.md#bytelength)

### Methods

- [digest](bun._bun_.SHA1.md#digest)
- [update](bun._bun_.SHA1.md#update)
- [hash](bun._bun_.SHA1.md#hash)
...
[bun.d.ts:1135](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/bun.d.ts#L1135)
...
[bun.d.ts:1140](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/bun.d.ts#L1140)
...
▸ **update**(`data`): [`SHA1`](bun._bun_.SHA1.md)
