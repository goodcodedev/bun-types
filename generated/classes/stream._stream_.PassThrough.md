...
[stream](../modules/stream.md).["stream"](../modules/stream._stream_.md).PassThrough
...
- [constructor](stream._stream_.PassThrough.md#constructor)

### Properties

- [allowHalfOpen](stream._stream_.PassThrough.md#allowhalfopen)
- [destroyed](stream._stream_.PassThrough.md#destroyed)
- [locked](stream._stream_.PassThrough.md#locked)
- [readable](stream._stream_.PassThrough.md#readable)
- [readableAborted](stream._stream_.PassThrough.md#readableaborted)
- [readableEncoding](stream._stream_.PassThrough.md#readableencoding)
- [readableEnded](stream._stream_.PassThrough.md#readableended)
- [readableFlowing](stream._stream_.PassThrough.md#readableflowing)
- [readableHighWaterMark](stream._stream_.PassThrough.md#readablehighwatermark)
- [readableLength](stream._stream_.PassThrough.md#readablelength)
- [readableObjectMode](stream._stream_.PassThrough.md#readableobjectmode)
- [writable](stream._stream_.PassThrough.md#writable)
- [writableCorked](stream._stream_.PassThrough.md#writablecorked)
- [writableEnded](stream._stream_.PassThrough.md#writableended)
- [writableFinished](stream._stream_.PassThrough.md#writablefinished)
- [writableHighWaterMark](stream._stream_.PassThrough.md#writablehighwatermark)
- [writableLength](stream._stream_.PassThrough.md#writablelength)
- [writableObjectMode](stream._stream_.PassThrough.md#writableobjectmode)
- [captureRejectionSymbol](stream._stream_.PassThrough.md#capturerejectionsymbol)
- [captureRejections](stream._stream_.PassThrough.md#capturerejections)
- [defaultMaxListeners](stream._stream_.PassThrough.md#defaultmaxlisteners)
- [errorMonitor](stream._stream_.PassThrough.md#errormonitor)

### Methods

- [[asyncIterator]](stream._stream_.PassThrough.md#[asynciterator])
- [\_construct](stream._stream_.PassThrough.md#_construct)
- [\_destroy](stream._stream_.PassThrough.md#_destroy)
- [\_final](stream._stream_.PassThrough.md#_final)
- [\_flush](stream._stream_.PassThrough.md#_flush)
- [\_read](stream._stream_.PassThrough.md#_read)
- [\_transform](stream._stream_.PassThrough.md#_transform)
- [\_write](stream._stream_.PassThrough.md#_write)
- [\_writev](stream._stream_.PassThrough.md#_writev)
- [abort](stream._stream_.PassThrough.md#abort)
- [addListener](stream._stream_.PassThrough.md#addlistener)
- [cancel](stream._stream_.PassThrough.md#cancel)
- [close](stream._stream_.PassThrough.md#close)
- [cork](stream._stream_.PassThrough.md#cork)
- [destroy](stream._stream_.PassThrough.md#destroy)
- [emit](stream._stream_.PassThrough.md#emit)
- [end](stream._stream_.PassThrough.md#end)
- [eventNames](stream._stream_.PassThrough.md#eventnames)
- [forEach](stream._stream_.PassThrough.md#foreach)
- [getMaxListeners](stream._stream_.PassThrough.md#getmaxlisteners)
- [getReader](stream._stream_.PassThrough.md#getreader)
- [getWriter](stream._stream_.PassThrough.md#getwriter)
- [isPaused](stream._stream_.PassThrough.md#ispaused)
- [listenerCount](stream._stream_.PassThrough.md#listenercount)
- [listeners](stream._stream_.PassThrough.md#listeners)
- [off](stream._stream_.PassThrough.md#off)
- [on](stream._stream_.PassThrough.md#on)
- [once](stream._stream_.PassThrough.md#once)
- [pause](stream._stream_.PassThrough.md#pause)
- [pipe](stream._stream_.PassThrough.md#pipe)
- [pipeThrough](stream._stream_.PassThrough.md#pipethrough)
- [pipeTo](stream._stream_.PassThrough.md#pipeto)
- [prependListener](stream._stream_.PassThrough.md#prependlistener)
- [prependOnceListener](stream._stream_.PassThrough.md#prependoncelistener)
- [push](stream._stream_.PassThrough.md#push)
- [rawListeners](stream._stream_.PassThrough.md#rawlisteners)
- [read](stream._stream_.PassThrough.md#read)
- [removeAllListeners](stream._stream_.PassThrough.md#removealllisteners)
- [removeListener](stream._stream_.PassThrough.md#removelistener)
- [resume](stream._stream_.PassThrough.md#resume)
- [setDefaultEncoding](stream._stream_.PassThrough.md#setdefaultencoding)
- [setEncoding](stream._stream_.PassThrough.md#setencoding)
- [setMaxListeners](stream._stream_.PassThrough.md#setmaxlisteners)
- [tee](stream._stream_.PassThrough.md#tee)
- [uncork](stream._stream_.PassThrough.md#uncork)
- [unpipe](stream._stream_.PassThrough.md#unpipe)
- [unshift](stream._stream_.PassThrough.md#unshift)
- [wrap](stream._stream_.PassThrough.md#wrap)
- [write](stream._stream_.PassThrough.md#write)
- [from](stream._stream_.PassThrough.md#from)
- [getEventListeners](stream._stream_.PassThrough.md#geteventlisteners)
- [isDisturbed](stream._stream_.PassThrough.md#isdisturbed)
- [listenerCount](stream._stream_.PassThrough.md#listenercount-1)
- [on](stream._stream_.PassThrough.md#on-1)
- [once](stream._stream_.PassThrough.md#once-1)
- [setMaxListeners](stream._stream_.PassThrough.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](stream._stream_.PassThrough.md#uncork) or [end](stream._stream_.PassThrough.md#end) methods are called.
...
Calling the [write](stream._stream_.PassThrough.md#write) method after calling [end](stream._stream_.PassThrough.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](stream._stream_.PassThrough.md#defaultmaxlisteners).
...
Calling [read](stream._stream_.PassThrough.md#read) after the `'end'` event has
...
The `writable.uncork()` method flushes all data buffered since [cork](stream._stream_.PassThrough.md#cork) was called.
...
using the [pipe](stream._stream_.PassThrough.md#pipe) method.
...
Unlike [push](stream._stream_.PassThrough.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](stream._stream_.PassThrough.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](stream._stream_.PassThrough.md#push) will reset the reading state appropriately,
...
When using an older Node.js library that emits `'data'` events and has a [pause](stream._stream_.PassThrough.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](stream._stream_.PassThrough.md#pipe). However, if calling `write()` is preferred, it is
