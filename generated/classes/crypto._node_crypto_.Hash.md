...
[crypto](../modules/crypto.md).["node:crypto"](../modules/crypto._node_crypto_.md).Hash
...
The [createHash](../modules/crypto._node_crypto_.md#createhash) method is used to create `Hash` instances. `Hash`objects are not to be created directly using the `new` keyword.
...
- [constructor](crypto._node_crypto_.Hash.md#constructor)

### Properties

- [allowHalfOpen](crypto._node_crypto_.Hash.md#allowhalfopen)
- [destroyed](crypto._node_crypto_.Hash.md#destroyed)
- [locked](crypto._node_crypto_.Hash.md#locked)
- [readable](crypto._node_crypto_.Hash.md#readable)
- [readableAborted](crypto._node_crypto_.Hash.md#readableaborted)
- [readableEncoding](crypto._node_crypto_.Hash.md#readableencoding)
- [readableEnded](crypto._node_crypto_.Hash.md#readableended)
- [readableFlowing](crypto._node_crypto_.Hash.md#readableflowing)
- [readableHighWaterMark](crypto._node_crypto_.Hash.md#readablehighwatermark)
- [readableLength](crypto._node_crypto_.Hash.md#readablelength)
- [readableObjectMode](crypto._node_crypto_.Hash.md#readableobjectmode)
- [writable](crypto._node_crypto_.Hash.md#writable)
- [writableCorked](crypto._node_crypto_.Hash.md#writablecorked)
- [writableEnded](crypto._node_crypto_.Hash.md#writableended)
- [writableFinished](crypto._node_crypto_.Hash.md#writablefinished)
- [writableHighWaterMark](crypto._node_crypto_.Hash.md#writablehighwatermark)
- [writableLength](crypto._node_crypto_.Hash.md#writablelength)
- [writableObjectMode](crypto._node_crypto_.Hash.md#writableobjectmode)
- [captureRejectionSymbol](crypto._node_crypto_.Hash.md#capturerejectionsymbol)
- [captureRejections](crypto._node_crypto_.Hash.md#capturerejections)
- [defaultMaxListeners](crypto._node_crypto_.Hash.md#defaultmaxlisteners)
- [errorMonitor](crypto._node_crypto_.Hash.md#errormonitor)

### Methods

- [[asyncIterator]](crypto._node_crypto_.Hash.md#[asynciterator])
- [\_construct](crypto._node_crypto_.Hash.md#_construct)
- [\_destroy](crypto._node_crypto_.Hash.md#_destroy)
- [\_final](crypto._node_crypto_.Hash.md#_final)
- [\_flush](crypto._node_crypto_.Hash.md#_flush)
- [\_read](crypto._node_crypto_.Hash.md#_read)
- [\_transform](crypto._node_crypto_.Hash.md#_transform)
- [\_write](crypto._node_crypto_.Hash.md#_write)
- [\_writev](crypto._node_crypto_.Hash.md#_writev)
- [abort](crypto._node_crypto_.Hash.md#abort)
- [addListener](crypto._node_crypto_.Hash.md#addlistener)
- [cancel](crypto._node_crypto_.Hash.md#cancel)
- [close](crypto._node_crypto_.Hash.md#close)
- [copy](crypto._node_crypto_.Hash.md#copy)
- [cork](crypto._node_crypto_.Hash.md#cork)
- [destroy](crypto._node_crypto_.Hash.md#destroy)
- [digest](crypto._node_crypto_.Hash.md#digest)
- [emit](crypto._node_crypto_.Hash.md#emit)
- [end](crypto._node_crypto_.Hash.md#end)
- [eventNames](crypto._node_crypto_.Hash.md#eventnames)
- [forEach](crypto._node_crypto_.Hash.md#foreach)
- [getMaxListeners](crypto._node_crypto_.Hash.md#getmaxlisteners)
- [getReader](crypto._node_crypto_.Hash.md#getreader)
- [getWriter](crypto._node_crypto_.Hash.md#getwriter)
- [isPaused](crypto._node_crypto_.Hash.md#ispaused)
- [listenerCount](crypto._node_crypto_.Hash.md#listenercount)
- [listeners](crypto._node_crypto_.Hash.md#listeners)
- [off](crypto._node_crypto_.Hash.md#off)
- [on](crypto._node_crypto_.Hash.md#on)
- [once](crypto._node_crypto_.Hash.md#once)
- [pause](crypto._node_crypto_.Hash.md#pause)
- [pipe](crypto._node_crypto_.Hash.md#pipe)
- [pipeThrough](crypto._node_crypto_.Hash.md#pipethrough)
- [pipeTo](crypto._node_crypto_.Hash.md#pipeto)
- [prependListener](crypto._node_crypto_.Hash.md#prependlistener)
- [prependOnceListener](crypto._node_crypto_.Hash.md#prependoncelistener)
- [push](crypto._node_crypto_.Hash.md#push)
- [rawListeners](crypto._node_crypto_.Hash.md#rawlisteners)
- [read](crypto._node_crypto_.Hash.md#read)
- [removeAllListeners](crypto._node_crypto_.Hash.md#removealllisteners)
- [removeListener](crypto._node_crypto_.Hash.md#removelistener)
- [resume](crypto._node_crypto_.Hash.md#resume)
- [setDefaultEncoding](crypto._node_crypto_.Hash.md#setdefaultencoding)
- [setEncoding](crypto._node_crypto_.Hash.md#setencoding)
- [setMaxListeners](crypto._node_crypto_.Hash.md#setmaxlisteners)
- [tee](crypto._node_crypto_.Hash.md#tee)
- [uncork](crypto._node_crypto_.Hash.md#uncork)
- [unpipe](crypto._node_crypto_.Hash.md#unpipe)
- [unshift](crypto._node_crypto_.Hash.md#unshift)
- [update](crypto._node_crypto_.Hash.md#update)
- [wrap](crypto._node_crypto_.Hash.md#wrap)
- [write](crypto._node_crypto_.Hash.md#write)
- [from](crypto._node_crypto_.Hash.md#from)
- [getEventListeners](crypto._node_crypto_.Hash.md#geteventlisteners)
- [isDisturbed](crypto._node_crypto_.Hash.md#isdisturbed)
- [listenerCount](crypto._node_crypto_.Hash.md#listenercount-1)
- [on](crypto._node_crypto_.Hash.md#on-1)
- [once](crypto._node_crypto_.Hash.md#once-1)
- [setMaxListeners](crypto._node_crypto_.Hash.md#setmaxlisteners-1)
...
[crypto.d.ts:349](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/crypto.d.ts#L349)
...
▸ **addListener**(`event`, `listener`): [`Hash`](crypto._crypto_.Hash.md)
...
▸ **copy**(`options?`): [`Hash`](crypto._crypto_.Hash.md)
...
[crypto.d.ts:382](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/crypto.d.ts#L382)
...
The buffered data will be flushed when either the [uncork](crypto._node_crypto_.Hash.md#uncork) or [end](crypto._node_crypto_.Hash.md#end) methods are called.
...
▸ **destroy**(`error?`): [`Hash`](crypto._crypto_.Hash.md)
...
[crypto.d.ts:403](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/crypto.d.ts#L403)
...
[crypto.d.ts:404](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/crypto.d.ts#L404)
...
▸ **end**(`cb?`): [`Hash`](crypto._crypto_.Hash.md)
...
Calling the [write](crypto._node_crypto_.Hash.md#write) method after calling [end](crypto._node_crypto_.Hash.md#end) will raise an error.
...
▸ **end**(`chunk`, `cb?`): [`Hash`](crypto._crypto_.Hash.md)
...
▸ **end**(`chunk`, `encoding?`, `cb?`): [`Hash`](crypto._crypto_.Hash.md)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](crypto._node_crypto_.Hash.md#defaultmaxlisteners).
...
▸ **off**(`eventName`, `listener`): [`Hash`](crypto._crypto_.Hash.md)
...
▸ **on**(`event`, `listener`): [`Hash`](crypto._crypto_.Hash.md)
...
▸ **once**(`event`, `listener`): [`Hash`](crypto._crypto_.Hash.md)
...
▸ **pause**(): [`Hash`](crypto._crypto_.Hash.md)
...
▸ **prependListener**(`event`, `listener`): [`Hash`](crypto._crypto_.Hash.md)
...
▸ **prependOnceListener**(`event`, `listener`): [`Hash`](crypto._crypto_.Hash.md)
...
Calling [read](crypto._node_crypto_.Hash.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`Hash`](crypto._crypto_.Hash.md)
...
▸ **removeListener**(`event`, `listener`): [`Hash`](crypto._crypto_.Hash.md)
...
▸ **resume**(): [`Hash`](crypto._crypto_.Hash.md)
...
▸ **setDefaultEncoding**(`encoding`): [`Hash`](crypto._crypto_.Hash.md)
...
▸ **setEncoding**(`encoding`): [`Hash`](crypto._crypto_.Hash.md)
...
▸ **setMaxListeners**(`n`): [`Hash`](crypto._crypto_.Hash.md)
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._node_crypto_.Hash.md#cork) was called.
...
▸ **unpipe**(`destination?`): [`Hash`](crypto._crypto_.Hash.md)

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](crypto._node_crypto_.Hash.md#pipe) method.
...
Unlike [push](crypto._node_crypto_.Hash.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](crypto._node_crypto_.Hash.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](crypto._node_crypto_.Hash.md#push) will reset the reading state appropriately,
...
▸ **update**(`data`): [`Hash`](crypto._crypto_.Hash.md)
...
[crypto.d.ts:392](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/crypto.d.ts#L392)

▸ **update**(`data`, `inputEncoding`): [`Hash`](crypto._crypto_.Hash.md)
...
[crypto.d.ts:393](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/crypto.d.ts#L393)

___

### wrap

▸ **wrap**(`stream`): [`Hash`](crypto._crypto_.Hash.md)

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](crypto._node_crypto_.Hash.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._node_crypto_.Hash.md#pipe). However, if calling `write()` is preferred, it is
