...
[domain](../modules/domain.md).["domain"](../modules/domain._domain_.md).Domain
...
- [constructor](domain._domain_.Domain.md#constructor)

### Properties

- [members](domain._domain_.Domain.md#members)
- [captureRejectionSymbol](domain._domain_.Domain.md#capturerejectionsymbol)
- [captureRejections](domain._domain_.Domain.md#capturerejections)
- [defaultMaxListeners](domain._domain_.Domain.md#defaultmaxlisteners)
- [errorMonitor](domain._domain_.Domain.md#errormonitor)

### Methods

- [add](domain._domain_.Domain.md#add)
- [addListener](domain._domain_.Domain.md#addlistener)
- [bind](domain._domain_.Domain.md#bind)
- [emit](domain._domain_.Domain.md#emit)
- [enter](domain._domain_.Domain.md#enter)
- [eventNames](domain._domain_.Domain.md#eventnames)
- [exit](domain._domain_.Domain.md#exit)
- [getMaxListeners](domain._domain_.Domain.md#getmaxlisteners)
- [intercept](domain._domain_.Domain.md#intercept)
- [listenerCount](domain._domain_.Domain.md#listenercount)
- [listeners](domain._domain_.Domain.md#listeners)
- [off](domain._domain_.Domain.md#off)
- [on](domain._domain_.Domain.md#on)
- [once](domain._domain_.Domain.md#once)
- [prependListener](domain._domain_.Domain.md#prependlistener)
- [prependOnceListener](domain._domain_.Domain.md#prependoncelistener)
- [rawListeners](domain._domain_.Domain.md#rawlisteners)
- [remove](domain._domain_.Domain.md#remove)
- [removeAllListeners](domain._domain_.Domain.md#removealllisteners)
- [removeListener](domain._domain_.Domain.md#removelistener)
- [run](domain._domain_.Domain.md#run)
- [setMaxListeners](domain._domain_.Domain.md#setmaxlisteners)
- [getEventListeners](domain._domain_.Domain.md#geteventlisteners)
- [listenerCount](domain._domain_.Domain.md#listenercount-1)
- [on](domain._domain_.Domain.md#on-1)
- [once](domain._domain_.Domain.md#once-1)
- [setMaxListeners](domain._domain_.Domain.md#setmaxlisteners-1)
...
stack managed by the domain module (see [exit](domain._domain_.Domain.md#exit) for details on the
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](domain._domain_.Domain.md#defaultmaxlisteners).
...
This method is almost identical to [bind](domain._domain_.Domain.md#bind). However, in
...
▸ **prependOnceListener**(`eventName`, `listener`): [`Domain`](domain._domain_.Domain.md)
...
The opposite of [add](domain._domain_.Domain.md#add). Removes domain handling from the
specified emitter.
...
[EventEmitter](events._events_.EventEmitter-1.md).[listenerCount](events._events_.EventEmitter-1.md#listenercount-1)
