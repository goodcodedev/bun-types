...
[stream](../modules/stream.md).["stream"](../modules/stream._stream_.md).Stream
...
- `internal`
  ...
  ↳↳ [`Readable`](stream._node_stream_.Readable.md)

  ↳↳ [`Writable`](stream._node_stream_.Writable.md)

## Table of contents

### Constructors

- [constructor](stream._stream_.Stream.md#constructor)

### Properties

- [captureRejectionSymbol](stream._stream_.Stream.md#capturerejectionsymbol)
- [captureRejections](stream._stream_.Stream.md#capturerejections)
- [defaultMaxListeners](stream._stream_.Stream.md#defaultmaxlisteners)
- [errorMonitor](stream._stream_.Stream.md#errormonitor)

### Methods

- [addListener](stream._stream_.Stream.md#addlistener)
- [emit](stream._stream_.Stream.md#emit)
- [eventNames](stream._stream_.Stream.md#eventnames)
- [getMaxListeners](stream._stream_.Stream.md#getmaxlisteners)
- [listenerCount](stream._stream_.Stream.md#listenercount)
- [listeners](stream._stream_.Stream.md#listeners)
- [off](stream._stream_.Stream.md#off)
- [on](stream._stream_.Stream.md#on)
- [once](stream._stream_.Stream.md#once)
- [pipe](stream._stream_.Stream.md#pipe)
- [prependListener](stream._stream_.Stream.md#prependlistener)
- [prependOnceListener](stream._stream_.Stream.md#prependoncelistener)
- [rawListeners](stream._stream_.Stream.md#rawlisteners)
- [removeAllListeners](stream._stream_.Stream.md#removealllisteners)
- [removeListener](stream._stream_.Stream.md#removelistener)
- [setMaxListeners](stream._stream_.Stream.md#setmaxlisteners)
- [getEventListeners](stream._stream_.Stream.md#geteventlisteners)
- [listenerCount](stream._stream_.Stream.md#listenercount-1)
- [on](stream._stream_.Stream.md#on-1)
- [once](stream._stream_.Stream.md#once-1)
- [setMaxListeners](stream._stream_.Stream.md#setmaxlisteners-1)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](stream._stream_.Stream.md#defaultmaxlisteners).
