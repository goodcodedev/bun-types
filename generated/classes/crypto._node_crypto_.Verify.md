...
[crypto](../modules/crypto.md).["node:crypto"](../modules/crypto._node_crypto_.md).Verify
...
The [createVerify](../modules/crypto._node_crypto_.md#createverify) method is used to create `Verify` instances.`Verify` objects are not to be created directly using the `new` keyword.
...
- [constructor](crypto._node_crypto_.Verify.md#constructor)

### Properties

- [destroyed](crypto._node_crypto_.Verify.md#destroyed)
- [locked](crypto._node_crypto_.Verify.md#locked)
- [writable](crypto._node_crypto_.Verify.md#writable)
- [writableCorked](crypto._node_crypto_.Verify.md#writablecorked)
- [writableEnded](crypto._node_crypto_.Verify.md#writableended)
- [writableFinished](crypto._node_crypto_.Verify.md#writablefinished)
- [writableHighWaterMark](crypto._node_crypto_.Verify.md#writablehighwatermark)
- [writableLength](crypto._node_crypto_.Verify.md#writablelength)
- [writableObjectMode](crypto._node_crypto_.Verify.md#writableobjectmode)
- [captureRejectionSymbol](crypto._node_crypto_.Verify.md#capturerejectionsymbol)
- [captureRejections](crypto._node_crypto_.Verify.md#capturerejections)
- [defaultMaxListeners](crypto._node_crypto_.Verify.md#defaultmaxlisteners)
- [errorMonitor](crypto._node_crypto_.Verify.md#errormonitor)

### Methods

- [\_construct](crypto._node_crypto_.Verify.md#_construct)
- [\_destroy](crypto._node_crypto_.Verify.md#_destroy)
- [\_final](crypto._node_crypto_.Verify.md#_final)
- [\_write](crypto._node_crypto_.Verify.md#_write)
- [\_writev](crypto._node_crypto_.Verify.md#_writev)
- [abort](crypto._node_crypto_.Verify.md#abort)
- [addListener](crypto._node_crypto_.Verify.md#addlistener)
- [close](crypto._node_crypto_.Verify.md#close)
- [cork](crypto._node_crypto_.Verify.md#cork)
- [destroy](crypto._node_crypto_.Verify.md#destroy)
- [emit](crypto._node_crypto_.Verify.md#emit)
- [end](crypto._node_crypto_.Verify.md#end)
- [eventNames](crypto._node_crypto_.Verify.md#eventnames)
- [getMaxListeners](crypto._node_crypto_.Verify.md#getmaxlisteners)
- [getWriter](crypto._node_crypto_.Verify.md#getwriter)
- [listenerCount](crypto._node_crypto_.Verify.md#listenercount)
- [listeners](crypto._node_crypto_.Verify.md#listeners)
- [off](crypto._node_crypto_.Verify.md#off)
- [on](crypto._node_crypto_.Verify.md#on)
- [once](crypto._node_crypto_.Verify.md#once)
- [pipe](crypto._node_crypto_.Verify.md#pipe)
- [prependListener](crypto._node_crypto_.Verify.md#prependlistener)
- [prependOnceListener](crypto._node_crypto_.Verify.md#prependoncelistener)
- [rawListeners](crypto._node_crypto_.Verify.md#rawlisteners)
- [removeAllListeners](crypto._node_crypto_.Verify.md#removealllisteners)
- [removeListener](crypto._node_crypto_.Verify.md#removelistener)
- [setDefaultEncoding](crypto._node_crypto_.Verify.md#setdefaultencoding)
- [setMaxListeners](crypto._node_crypto_.Verify.md#setmaxlisteners)
- [uncork](crypto._node_crypto_.Verify.md#uncork)
- [update](crypto._node_crypto_.Verify.md#update)
- [verify](crypto._node_crypto_.Verify.md#verify)
- [write](crypto._node_crypto_.Verify.md#write)
- [getEventListeners](crypto._node_crypto_.Verify.md#geteventlisteners)
- [listenerCount](crypto._node_crypto_.Verify.md#listenercount-1)
- [on](crypto._node_crypto_.Verify.md#on-1)
- [once](crypto._node_crypto_.Verify.md#once-1)
- [setMaxListeners](crypto._node_crypto_.Verify.md#setmaxlisteners-1)
...
The buffered data will be flushed when either the [uncork](crypto._node_crypto_.Verify.md#uncork) or [end](crypto._node_crypto_.Verify.md#end) methods are called.
...
Calling the [write](crypto._node_crypto_.Verify.md#write) method after calling [end](crypto._node_crypto_.Verify.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](crypto._node_crypto_.Verify.md#defaultmaxlisteners).
...
The `writable.uncork()` method flushes all data buffered since [cork](crypto._node_crypto_.Verify.md#cork) was called.
...
If `object` is not a `KeyObject`, this function behaves as if`object` had been passed to [createPublicKey](../modules/crypto._node_crypto_.md#createpublickey). If it is an
...
recommended to encapsulate the logic into a `Readable` and use [pipe](crypto._node_crypto_.Verify.md#pipe). However, if calling `write()` is preferred, it is
