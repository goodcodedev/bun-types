...
[http](../modules/http.md).["node:https"](../modules/http._node_https_.md).IncomingMessage

An `IncomingMessage` object is created by Server or [ClientRequest](http._node_https_.ClientRequest.md) and passed as the first argument to the `'request'` and `'response'` event respectively. It may be used to
access response
...
- [constructor](http._node_https_.IncomingMessage.md#constructor)

### Properties

- [aborted](http._node_https_.IncomingMessage.md#aborted)
- [complete](http._node_https_.IncomingMessage.md#complete)
- [destroyed](http._node_https_.IncomingMessage.md#destroyed)
- [headers](http._node_https_.IncomingMessage.md#headers)
- [httpVersion](http._node_https_.IncomingMessage.md#httpversion)
- [httpVersionMajor](http._node_https_.IncomingMessage.md#httpversionmajor)
- [httpVersionMinor](http._node_https_.IncomingMessage.md#httpversionminor)
- [locked](http._node_https_.IncomingMessage.md#locked)
- [method](http._node_https_.IncomingMessage.md#method)
- [rawHeaders](http._node_https_.IncomingMessage.md#rawheaders)
- [rawTrailers](http._node_https_.IncomingMessage.md#rawtrailers)
- [readable](http._node_https_.IncomingMessage.md#readable)
- [readableAborted](http._node_https_.IncomingMessage.md#readableaborted)
- [readableEncoding](http._node_https_.IncomingMessage.md#readableencoding)
- [readableEnded](http._node_https_.IncomingMessage.md#readableended)
- [readableFlowing](http._node_https_.IncomingMessage.md#readableflowing)
- [readableHighWaterMark](http._node_https_.IncomingMessage.md#readablehighwatermark)
- [readableLength](http._node_https_.IncomingMessage.md#readablelength)
- [readableObjectMode](http._node_https_.IncomingMessage.md#readableobjectmode)
- [statusCode](http._node_https_.IncomingMessage.md#statuscode)
- [statusMessage](http._node_https_.IncomingMessage.md#statusmessage)
- [trailers](http._node_https_.IncomingMessage.md#trailers)
- [url](http._node_https_.IncomingMessage.md#url)
- [captureRejectionSymbol](http._node_https_.IncomingMessage.md#capturerejectionsymbol)
- [captureRejections](http._node_https_.IncomingMessage.md#capturerejections)
- [defaultMaxListeners](http._node_https_.IncomingMessage.md#defaultmaxlisteners)
- [errorMonitor](http._node_https_.IncomingMessage.md#errormonitor)

### Methods

- [[asyncIterator]](http._node_https_.IncomingMessage.md#[asynciterator])
- [\_construct](http._node_https_.IncomingMessage.md#_construct)
- [\_destroy](http._node_https_.IncomingMessage.md#_destroy)
- [\_read](http._node_https_.IncomingMessage.md#_read)
- [addListener](http._node_https_.IncomingMessage.md#addlistener)
- [cancel](http._node_https_.IncomingMessage.md#cancel)
- [destroy](http._node_https_.IncomingMessage.md#destroy)
- [emit](http._node_https_.IncomingMessage.md#emit)
- [eventNames](http._node_https_.IncomingMessage.md#eventnames)
- [forEach](http._node_https_.IncomingMessage.md#foreach)
- [getMaxListeners](http._node_https_.IncomingMessage.md#getmaxlisteners)
- [getReader](http._node_https_.IncomingMessage.md#getreader)
- [isPaused](http._node_https_.IncomingMessage.md#ispaused)
- [listenerCount](http._node_https_.IncomingMessage.md#listenercount)
- [listeners](http._node_https_.IncomingMessage.md#listeners)
- [off](http._node_https_.IncomingMessage.md#off)
- [on](http._node_https_.IncomingMessage.md#on)
- [once](http._node_https_.IncomingMessage.md#once)
- [pause](http._node_https_.IncomingMessage.md#pause)
- [pipe](http._node_https_.IncomingMessage.md#pipe)
- [pipeThrough](http._node_https_.IncomingMessage.md#pipethrough)
- [pipeTo](http._node_https_.IncomingMessage.md#pipeto)
- [prependListener](http._node_https_.IncomingMessage.md#prependlistener)
- [prependOnceListener](http._node_https_.IncomingMessage.md#prependoncelistener)
- [push](http._node_https_.IncomingMessage.md#push)
- [rawListeners](http._node_https_.IncomingMessage.md#rawlisteners)
- [read](http._node_https_.IncomingMessage.md#read)
- [removeAllListeners](http._node_https_.IncomingMessage.md#removealllisteners)
- [removeListener](http._node_https_.IncomingMessage.md#removelistener)
- [resume](http._node_https_.IncomingMessage.md#resume)
- [setEncoding](http._node_https_.IncomingMessage.md#setencoding)
- [setMaxListeners](http._node_https_.IncomingMessage.md#setmaxlisteners)
- [setTimeout](http._node_https_.IncomingMessage.md#settimeout)
- [tee](http._node_https_.IncomingMessage.md#tee)
- [unpipe](http._node_https_.IncomingMessage.md#unpipe)
- [unshift](http._node_https_.IncomingMessage.md#unshift)
- [wrap](http._node_https_.IncomingMessage.md#wrap)
- [from](http._node_https_.IncomingMessage.md#from)
- [getEventListeners](http._node_https_.IncomingMessage.md#geteventlisteners)
- [isDisturbed](http._node_https_.IncomingMessage.md#isdisturbed)
- [listenerCount](http._node_https_.IncomingMessage.md#listenercount-1)
- [on](http._node_https_.IncomingMessage.md#on-1)
- [once](http._node_https_.IncomingMessage.md#once-1)
- [setMaxListeners](http._node_https_.IncomingMessage.md#setmaxlisteners-1)
...
| Name | Type |
| :------ | :------ |
| `opts?` | [`ReadableOptions`](../interfaces/stream._stream_.ReadableOptions.md) |
...
[stream.d.ts:122](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/stream.d.ts#L122)
...
[http.d.ts:459](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L459)
...
[http.d.ts:492](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L492)
...
• **headers**: [`IncomingHttpHeaders`](../interfaces/http._http_.IncomingHttpHeaders.md)
...
[http.d.ts:516](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L516)
...
[http.d.ts:467](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L467)
...
[http.d.ts:468](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L468)
...
[http.d.ts:469](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L469)
...
[http.d.ts:559](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L559)
...
[http.d.ts:540](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L540)
...
[http.d.ts:549](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L549)
...
**Only valid for response obtained from [ClientRequest](http._node_https_.ClientRequest.md).**

The 3-digit HTTP response status code. E.G. `404`.

#### Defined in

[http.d.ts:604](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L604)
...
[http.d.ts:610](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L610)

___

### trailers

• **trailers**: [`Dict`](../interfaces/globals.Dict.md)<`string`\>

The request/response trailers object. Only populated at the `'end'` event.

#### Defined in

[http.d.ts:544](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L544)
...
[http.d.ts:598](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L598)
...
[stream.d.ts:397](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/stream.d.ts#L397)
...
▸ **addListener**(`event`, `listener`): [`IncomingMessage`](http._http_.IncomingMessage.md)
...
[`IncomingMessage`](http._http_.IncomingMessage.md)
...
▸ **destroy**(`error?`): [`IncomingMessage`](http._http_.IncomingMessage.md)
...
[http.d.ts:615](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L615)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](http._node_https_.IncomingMessage.md#defaultmaxlisteners).
...
▸ **off**(`eventName`, `listener`): [`IncomingMessage`](http._http_.IncomingMessage.md)
...
▸ **on**(`event`, `listener`): [`IncomingMessage`](http._http_.IncomingMessage.md)
...
▸ **once**(`event`, `listener`): [`IncomingMessage`](http._http_.IncomingMessage.md)
...
▸ **pause**(): [`IncomingMessage`](http._http_.IncomingMessage.md)
...
▸ **prependListener**(`event`, `listener`): [`IncomingMessage`](http._http_.IncomingMessage.md)
...
▸ **prependOnceListener**(`event`, `listener`): [`IncomingMessage`](http._http_.IncomingMessage.md)
...
Calling [read](http._node_https_.IncomingMessage.md#read) after the `'end'` event has
...
▸ **removeAllListeners**(`event?`): [`IncomingMessage`](http._http_.IncomingMessage.md)
...
▸ **removeListener**(`event`, `listener`): [`IncomingMessage`](http._http_.IncomingMessage.md)
...
▸ **resume**(): [`IncomingMessage`](http._http_.IncomingMessage.md)
...
▸ **setEncoding**(`encoding`): [`IncomingMessage`](http._http_.IncomingMessage.md)
...
▸ **setMaxListeners**(`n`): [`IncomingMessage`](http._http_.IncomingMessage.md)
...
▸ **setTimeout**(`msecs`, `callback?`): [`IncomingMessage`](http._http_.IncomingMessage.md)
...
[http.d.ts:553](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/http.d.ts#L553)
...
▸ **unpipe**(`destination?`): [`IncomingMessage`](http._http_.IncomingMessage.md)

The `readable.unpipe()` method detaches a `Writable` stream previously attached
using the [pipe](http._node_https_.IncomingMessage.md#pipe) method.
...
Unlike [push](http._node_https_.IncomingMessage.md#push), `stream.unshift(chunk)` will not
end the reading process by resetting the internal reading state of the stream.
This can cause unexpected results if `readable.unshift()` is called during a
read (i.e. from within a [_read](http._node_https_.IncomingMessage.md#_read) implementation on a
custom stream). Following the call to `readable.unshift()` with an immediate [push](http._node_https_.IncomingMessage.md#push) will reset the reading state appropriately,
...
▸ **wrap**(`stream`): [`IncomingMessage`](http._http_.IncomingMessage.md)

Prior to Node.js 0.10, streams did not implement the entire `stream` module API
as it is currently defined. (See `Compatibility` for more information.)

When using an older Node.js library that emits `'data'` events and has a [pause](http._node_https_.IncomingMessage.md#pause) method that is advisory only, the`readable.wrap()` method can be used to create a `Readable`
stream that uses
...
▸ `Static` **from**(`iterable`, `options?`): [`Readable`](stream._stream_.Readable.md)<`any`\>
...
| `options?` | [`ReadableOptions`](../interfaces/stream._stream_.ReadableOptions.md) |

#### Returns

[`Readable`](stream._stream_.Readable.md)<`any`\>
...
[stream.d.ts:73](https://github.com/goodcodedev/bun-types/blob/8bd1b3a/stream.d.ts#L73)
